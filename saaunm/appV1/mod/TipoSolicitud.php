...
/**
	function compAgregarcambiarTabla1cambiarTabla2($idTipoSolicitud, $solTipoSolicitud, $fecIniTipoSolicitud, $segTipoSolicitud) {
		$objcambiarTabla1 = new cambiarTabla1();
		$objcambiarTabla1->beginTransaction();
		$resultado1 = cambiarTabla1::agregarcambiarTabla1('aqui van los campos de tabla1');
		$idcambiarTabla1 = $objcambiarTabla1->consultarcambiarTabla1UltimoId();
		$resultado2 = cambiarTabla2::agregarcambiarTabla2($idTipoSolicitud, $solTipoSolicitud, $fecIniTipoSolicitud, $segTipoSolicitud, $id_TipoSolicitud);
	...
	function compActualizarcambiarTabla1cambiarTabla2($idTipoSolicitud, $solTipoSolicitud, $fecIniTipoSolicitud, $segTipoSolicitud) {
		$objcambiarTabla1 = new cambiarTabla1();
		$objcambiarTabla1->beginTransaction();
		$resultado1 = cambiarTabla1::actualizarcambiarTabla1('aqui van los campos de tabla1');
		$resultado2 = cambiarTabla2::actualizarcambiarTabla2($idTipoSolicitud, $solTipoSolicitud, $fecIniTipoSolicitud, $segTipoSolicitud, $id_TipoSolicitud);
		if ($resultado1>0 AND $resultado2>0) {
			cambiarTabla2::commitTransaction();
			$objcambiarTabla1->commitTransaction();
			cambiarTabla2::desconectar();
	...
	*/ 
	function agregarTipoSolicitud($idTipoSolicitud, $solTipoSolicitud, $fecIniTipoSolicitud, $segTipoSolicitud) {
...
$solTipoSolicitud = parent::prepareParam($solTipoSolicitud, Query::DATATYPE_STRING, 0);
		...
		$params = array($idTipoSolicitud, $solTipoSolicitud, $fecIniTipoSolicitud, $segTipoSolicitud);
		return parent::execute(SQLTipoSolicitud::AGREGAR_TIPOSOLICITUD, $params);
	}

	function actualizarTipoSolicitud($idTipoSolicitud, $solTipoSolicitud, $fecIniTipoSolicitud, $segTipoSolicitud, $id_TipoSolicitud){
		
$idTipoSolicitud = parent::prepareParam($idTipoSolicitud, Query::DATATYPE_INTEGER);
$solTipoSolicitud = parent::prepareParam($solTipoSolicitud, Query::DATATYPE_STRING, 0);

		
		$params = array($idTipoSolicitud, $solTipoSolicitud, $fecIniTipoSolicitud, $segTipoSolicitud, $id_TipoSolicitud);
