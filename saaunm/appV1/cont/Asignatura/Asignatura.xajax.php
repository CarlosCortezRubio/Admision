...
/* FIN PAGINACION */ 
			$etiquetas = array('','Imp','Ver','Editar','Id','Estado','Código','Nombre','Nombre Corto');
		if ($resultado!=null) {
...
// 			$campos = array('obj_' . $chk, 'obj_' . $img3,'obj_' . $img, 'obj_' . $img1,'idAsignatura','idTipoEvaluac','idTipoAsignatura','idEdoRegistro','codAsignatura','nomAsignatura','nomCortoAsignatura','pracLabAsignatura');
			$campos = array('obj_' . $chk, 'obj_' . $img3,'obj_' . $img, 'obj_' . $img1,'Estado','Código','Nombre','Nombre corto');
