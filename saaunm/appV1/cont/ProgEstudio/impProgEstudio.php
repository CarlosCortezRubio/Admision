...
$aux = $opt; 
		...
		if ($tabla > 0) {
			$etiquetas = array('id', 'idEmpleado', 'cod', 'nom', 'nomCorto', 'numResAuto', 'fecResAuto', 'preInsc', 'gpo', 'numResReva', 'fecResReva');
			$campos = array('idProgEstudio', 'idEmpleado', 'codProgEstudio', 'nomProgEstudio', 'nomCortoProgEstudio', 'numResAutoProgEstudio', 'fecResAutoProgEstudio', 'preInscProgEstudio', 'gpoProgEstudio', 'numResRevaProgEstudio', 'fecResRevaProgEstudio');
