...
/* FIN PAGINACION */ 
			$etiquetas = array('','Imp','Ver','Editar','Id','Sol','FecIni','Seg');
		if ($resultado!=null) {
			...
			$campos = array('obj_' . $chk, 'obj_' . $img3,'obj_' . $img, 'obj_' . $img1,'idTipoSolicitud','solTipoSolicitud','fecIniTipoSolicitud','segTipoSolicitud');
