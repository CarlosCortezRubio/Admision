...
$action = new Action ();
$arrayFunciones = Array ("llenarGridPeriodo", "clickPeriodo", "vntActClave");
if (! isset ( $xajax )) {
...
/* FIN PAGINACION */ 
			$etiquetas = array('','Imp','Ver','Editar','Id','Estado','Nombr','Fecha Ini','Fecha Fin','Ordenamiento');
		if ($resultado!=null) {
			...
			$campos = array('obj_' . $chk, 'obj_' . $img3,'obj_' . $img, 'obj_' . $img1,'idPeriodo','idEdoRegistro','nomPeriodo','fecIniPeriodo','fecFinPeriodo','OrdPeriodo');
