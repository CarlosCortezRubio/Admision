...
{ 
  const AGREGAR_TIPOSOLICITUD = "INSERT INTO TipoSolicitud (idTipoSolicitud, solTipoSolicitud, fecIniTipoSolicitud, segTipoSolicitud) VALUES (?, ?, ?, ?) ";

  const ACTUALIZAR_TIPOSOLICITUD = "UPDATE TipoSolicitud SET idTipoSolicitud = ?, solTipoSolicitud = ?, fecIniTipoSolicitud = ?, segTipoSolicitud = ? WHERE idTipoSolicitud = ?";
