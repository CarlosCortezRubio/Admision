...
<div id='paginacion1'></div>
        ...
        <script>
                ...
                gridAsignatura.setHeader('|Imp|Ver|Editar|Id|Estado|Código|Nombre|Nombre Corto');
                gridAsignatura.enableColumnAutoSize(true);
                gridAsignatura.setInitWidths('25|60|60|60||93|*|*');
                gridAsignatura.setColAlign('center|center|center|center|right|right|right|right|left|left|left|right');
//              gridAsignatura.attachEvent('onRowDblClicked',eliminarCondicion);
                gridAsignatura.setColTypes('ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro');
                gridAsignatura.setColSorting('str|str|str|str|int|int|int|int|str|str|str|int');
