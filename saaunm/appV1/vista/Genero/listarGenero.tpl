...
<div id='paginacion1'></div>
        ...
        <script>
                ...
                gridGenero.setHeader('|Imp|Ver|Editar|IDGENERO|IdPersona|NOMGENERO');
                gridGenero.enableColumnAutoSize(true);
                gridGenero.setInitWidths('25|60|60|60|98|99|99');
                gridGenero.setColAlign('center|center|center|center|right|right|left');
//              gridGenero.attachEvent('onRowDblClicked',eliminarCondicion);
                gridGenero.setColTypes('ro|ro|ro|ro|ro|ro|ro');
                gridGenero.setColSorting('str|str|str|str|int|int|str');
