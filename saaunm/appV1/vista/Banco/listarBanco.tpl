...
<div id='paginacion1'></div>
        ...
        <script>
                ...
                gridBanco.setHeader('|Imp|Ver|Editar|IDBANCO|Edo_idEdoRegistro|NOMBANCO|ETIBANCO');
                gridBanco.enableColumnAutoSize(true);
                gridBanco.setInitWidths('25|60|60|60|97|107|98|98');
                gridBanco.setColAlign('center|center|center|center|right|right|left|left');
//              gridBanco.attachEvent('onRowDblClicked',eliminarCondicion);
                gridBanco.setColTypes('ro|ro|ro|ro|ro|ro|ro|ro');
                gridBanco.setColSorting('str|str|str|str|int|int|str|str');
