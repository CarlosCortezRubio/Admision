...
<div id='paginacion1'></div>
        ...
        <script>
                ...
                gridUsuario.setHeader('|Imp|Ver|Editar|IDUSUARIO|IDROL|Edo_idEdoRegistro|IdPersona|CUENTAUSUARIO|CONTRASENAUSUARIO|FECCREACION|PREGSECRETA|RESPPREGSECRETA');
                gridUsuario.enableColumnAutoSize(true);
                gridUsuario.setInitWidths('25|60|60|60|99|95|107|99|103|107|101|101|105');
                gridUsuario.setColAlign('center|center|center|center|right|right|right|right|left|left|left|left|left');
//              gridUsuario.attachEvent('onRowDblClicked',eliminarCondicion);
                gridUsuario.setColTypes('ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro');
                gridUsuario.setColSorting('str|str|str|str|int|int|int|int|str|str|str|str|str');
