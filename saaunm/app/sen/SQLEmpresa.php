...
class SQLEmpresa 
{ 
  const AGREGAR_EMPRESA = "INSERT INTO Empresa (idEmpresa, idEdoRegistro, rucEmpresa, telEmpresa, dirEmpresa, correoEmpresa) VALUES (?, ?, ?, ?, ?, ?) ";

  const ACTUALIZAR_EMPRESA = "UPDATE Empresa SET idEmpresa = ?, idEdoRegistro = ?, rucEmpresa = ?, telEmpresa = ?, dirEmpresa = ?, correoEmpresa = ? WHERE idEmpresa = ?";
  ...
  const CONSULTAR_EMPRESA_POR_IDEDOREGISTRO = "SELECT * FROM Empresa WHERE idEdoRegistroEmpresa = ?";
