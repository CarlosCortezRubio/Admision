...
<div id='paginacion1'></div>
        ...
        <script>
                ...
                gridEmpleado.setHeader('Imp|Ver|Id|Documento|Primer Nombre|Segundo Nombre|Apellido Paterno|Apellido Materno|Fecha Nac');
                gridEmpleado.enableColumnAutoSize(true);
                gridEmpleado.setInitWidths('60|60|60|99|101|130|*|*|150|');
