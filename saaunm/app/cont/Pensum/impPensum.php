...
$aux = $opt; 
		...
		$tabla = $objPensum->consultarPensumXidPensum($aux);
		$objPensum->cerrarConexion();
		if ($tabla > 0) {
			$etiquetas = array('id', 'idEdoRegistro', 'nom');
			$campos = array('idPensum', 'idEdoRegistro', 'nomPensum');
