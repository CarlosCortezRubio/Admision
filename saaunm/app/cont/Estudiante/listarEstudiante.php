...
//		$this->visualizar('principal/error.tpl');
	...
	function datosTabla($request,$session){
        ...
        $modulo = "Estudiante";
        $titModulo = "Estudiante";
        $campoClave = "idEstudiante";
        $etiquetas = array(
            "#",
            "Imp",
            "Ver",
            "Editar","Id Estudiante","IdEdoRegistro Estudiante"
        );
        ...
        $campos = array(
            ...
            "obj_" . $imgImp,
            "obj_" . $imgVer,
            "obj_" . $imgEdi,"idEstudiante","idEdoRegistro"
        );
//         echo "$encabezado"; // Permite imprimir un titulo al grid
        ...
        $objEstudiante = new Estudiante();
        $tablaResultado = $objEstudiante->consultarEstudiante(); // EDITABLE
        $objEstudiante->cerrarConexion();
