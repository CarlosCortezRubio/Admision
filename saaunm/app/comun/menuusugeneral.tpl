    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
        	...
        	<a class="dropdown-item" href="{$URLSIST}base/Pensum">Pensum</a>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
        	<a class="dropdown-item" href="{$URLSIST}base/Empleado">Listar Docentes</a>
        	<a class="dropdown-item" href="{$URLSIST}base/EstCur">Ingresar Calificaciones</a>
        	<a class="dropdown-item" href="{$URLSIST}base/Curso/MiHorarioDoc">Ver sus horarios</a>
        </div>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
