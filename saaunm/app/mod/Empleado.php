...
/**
	...
	*/ 
	function agregarEmpleado($idEmpleado, $idPersona, $idSituacion, $idTipRegistro, $idSegSalud, $idTipoPlanilla, $idCodFiscal, $idAfp, $idCodRegional, $idUniEjecutora, $idNEC, $idNivel, $idEstablecimiento, $idRegLaboral, $idTipServidor, $idNumMagist, $idGpoRemunerativo, $idhatEmb, $idCargoOrigen, $idNivelOrigen, $idPalMagist, $idDirEncargo, $codModular, $fecIngAdmPubEmpleado, $fecIngMedEmpleado, $fecCeseEmpleado, $infCompEmpleado, $fecHabEmpleado, $fecDesEmpleado, $fecFallEmpleado, $valPorEmpleado, $fecValEmpleado, $docRefEmpleado, $numSegSaludEmpleado, $eVidaEmpleado, $CUSPPEmpleado, $fecAfiPenEmpleado, $fecDevPenEmpleado, $plazaEmpleado, $tipPlazaEmpleado, $asigInserEmpleado, $diasTrabEmpleado, $numDepEmpleado, $numDecEmpleado, $licDiasEmpleado, $tipServEmpleado, $fecIniLicEmpleado, $insasitEmpleado, $permisosEmpleado, $huelgasEmpleado, $leyMenEmpleado, $leyPerEmpleado, $cadPresupEmpleado, $ctaEmpleado, $sueldo, $preG) {
		...
		$sueldo = parent::prepareParam($sueldo, Query::DATATYPE_DOUBLE);
	...
	function actualizarEmpleado($idEmpleado, $idPersona, $idSituacion, $idTipRegistro, $idSegSalud, $idTipoPlanilla, $idCodFiscal, $idAfp, $idCodRegional, $idUniEjecutora, $idNEC, $idNivel, $idEstablecimiento, $idRegLaboral, $idTipServidor, $idNumMagist, $idGpoRemunerativo, $idhatEmb, $idCargoOrigen, $idNivelOrigen, $idPalMagist, $idDirEncargo, $codModular, $fecIngAdmPubEmpleado, $fecIngMedEmpleado, $fecCeseEmpleado, $infCompEmpleado, $fecHabEmpleado, $fecDesEmpleado, $fecFallEmpleado, $valPorEmpleado, $fecValEmpleado, $docRefEmpleado, $numSegSaludEmpleado, $eVidaEmpleado, $CUSPPEmpleado, $fecAfiPenEmpleado, $fecDevPenEmpleado, $plazaEmpleado, $tipPlazaEmpleado, $asigInserEmpleado, $diasTrabEmpleado, $numDepEmpleado, $numDecEmpleado, $licDiasEmpleado, $tipServEmpleado, $fecIniLicEmpleado, $insasitEmpleado, $permisosEmpleado, $huelgasEmpleado, $leyMenEmpleado, $leyPerEmpleado, $cadPresupEmpleado, $ctaEmpleado, $sueldo, $preG, $id_Empleado)
	{		
		$idEmpleado = parent::prepareParam($idEmpleado, Query::DATATYPE_INTEGER);
		$idPersona = parent::prepareParam($idPersona, Query::DATATYPE_INTEGER);
		$idSituacion = parent::prepareParam($idSituacion, Query::DATATYPE_INTEGER);
		...
		$params = array($idEmpleado, $idPersona, $idSituacion, $idTipRegistro, $idSegSalud, $idTipoPlanilla, $idCodFiscal, $idAfp, $idCodRegional, $idUniEjecutora, $idNEC, $idNivel, $idEstablecimiento, $idRegLaboral, $idTipServidor, $idNumMagist, $idGpoRemunerativo, $idhatEmb, $idCargoOrigen, $idNivelOrigen, $idPalMagist, $idDirEncargo, $codModular, $fecIngAdmPubEmpleado, $fecIngMedEmpleado, $fecCeseEmpleado, $infCompEmpleado, $fecHabEmpleado, $fecDesEmpleado, $fecFallEmpleado, $valPorEmpleado, $fecValEmpleado, $docRefEmpleado, $numSegSaludEmpleado, $eVidaEmpleado, $CUSPPEmpleado, $fecAfiPenEmpleado, $fecDevPenEmpleado, $plazaEmpleado, $tipPlazaEmpleado, $asigInserEmpleado, $diasTrabEmpleado, $numDepEmpleado, $numDecEmpleado, $licDiasEmpleado, $tipServEmpleado, $fecIniLicEmpleado, $insasitEmpleado, $permisosEmpleado, $huelgasEmpleado, $leyMenEmpleado, $leyPerEmpleado, $cadPresupEmpleado, $ctaEmpleado, $sueldo, $preG, $idEmpleado);
		return parent::execute(SQLEmpleado::ACTUALIZAR_EMPLEADO, $params);		
	}

	function actualizaLicDias($idEmpleado, $licDiasEmpleado)
	{	
		
		$diasActual= $this->existeDiasLicXidEmpleado($idEmpleado);

		$diasActual= $diasActual[0][1]+$licDiasEmpleado;
		
		//var_dump($idEmpleado);
		//die('dias ACtuales');
		
		$idEmpleado = parent::prepareParam($idEmpleado, Query::DATATYPE_INTEGER);
		$diasActual = parent::prepareParam($diasActual, Query::DATATYPE_INTEGER);		
		
		$params = array($diasActual, $idEmpleado);
			
		return parent::execute(SQLEmpleado::ACTUALIZAR_LICDIAS, $params);		
	}
	...
	function existeDiasLicXidEmpleado($idEmpleado){

		$params = array($idEmpleado);
		$tabla = parent::executeQuery(SQLEmpleado::CONSULTAR_DIAS_LICENCIA, $params);
		//var_dump($tabla);
		//die('estos son los dios que tiene');
		if ($tabla >0) {
			return $tabla;			
		}
		return false;
