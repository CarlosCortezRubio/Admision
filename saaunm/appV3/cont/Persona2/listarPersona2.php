...
//		$this->visualizar('principal/error.tpl');
	...
	function datosTabla($request,$session){
        ...
        $modulo = "Persona2";
        $titModulo = "Persona2";
        $campoClave = "idPersona2";
        $etiquetas = array(
            "#",
            "Imp",
            "Ver",
            "Editar","IdPersona Persona2","Edo_IDEDOCIVIL Persona2","IDBANCO Persona2","IdEdoRegistro Persona2","IdGenero Persona2","IdEdoCivil Persona2","IdIdioma Persona2","IdDistritoNac Persona2","IdDistritoDir Persona2","IdTipoDoc Persona2","IdZona Persona2","IdVia Persona2","DniPersona Persona2","Nom1Persona Persona2","Nom2Persona Persona2","Ape1Persona Persona2","Ape2Persona Persona2","NumDepPersona Persona2","FecNacPersona Persona2","ZonaDomPersona Persona2","DesViaDomPersona Persona2","NumViaDomPersona Persona2","IntDomPersona Persona2","Tel1DomPersona Persona2","Tel2DomPersona Persona2","RefDomPersona Persona2","EmaDomPersona Persona2"
        );
        ...
        $campos = array(
            ...
            "obj_" . $imgImp,
            "obj_" . $imgVer,
            "obj_" . $imgEdi,"idPersona","Edo_IDEDOCIVIL","IDBANCO","idEdoRegistro","idGenero","idEdoCivil","idIdioma","idDistritoNac","idDistritoDir","idTipoDoc","idZona","idVia","dniPersona","nom1Persona","nom2Persona","ape1Persona","ape2Persona","numDepPersona","fecNacPersona","zonaDomPersona","desViaDomPersona","numViaDomPersona","intDomPersona","tel1DomPersona","tel2DomPersona","refDomPersona","emaDomPersona"
        );
//         echo "$encabezado"; // Permite imprimir un titulo al grid
        ...
        $objPersona2 = new Persona2();
        $tablaResultado = $objPersona2->consultarPersona2(); // EDITABLE
        $objPersona2->cerrarConexion();
