 ...
 * @file prelaasig.php 
 *  
 * Imprimir de la Tabla PrelaAsig 
 * 
 * @author UNM 
 * @version V 0.1 
 * @date 08/12/2021
...
$aux = $opt; 
		...
		$tabla = $objPrelaAsig->consultarPrelaAsigXidPrelaAsig($aux);
		$objPrelaAsig->cerrarConexion();
		if ($tabla > 0) {
			$etiquetas = array('idPenAsig', 'idAsignatura', 'id');
			$campos = array('idPenAsig', 'idAsignatura', 'idPrelaAsig');
