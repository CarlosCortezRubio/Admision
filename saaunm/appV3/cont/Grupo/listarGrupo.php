...
//		$this->visualizar('principal/error.tpl');
	...
	function datosTabla($request,$session){
        ...
        $etiquetas = array(
            ...
            "Imp",
            "Ver",
            "Editar","Id Grupo","IdCiclo Grupo","IdPensum Grupo","IdPeriodo Grupo","IdProgEstudio Grupo","IdEmpleado Grupo","IdSede Grupo","Nom Grupo","Cod Grupo"
        );
        ...
        $campos = array(
            ...
            "obj_" . $imgImp,
            "obj_" . $imgVer,
            "obj_" . $imgEdi,"idGrupo","idCiclo","idPensum","idPeriodo","idProgEstudio","idEmpleado","idSede","nomGrupo","codGrupo"
        );
//         echo "$encabezado"; // Permite imprimir un titulo al grid
        ...
        $objGrupo = new Grupo();
        $tablaResultado = $objGrupo->consultarGrupo(); // EDITABLE
        $objGrupo->cerrarConexion();
