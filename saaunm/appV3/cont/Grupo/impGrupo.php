...
$aux = $opt; 
		...
		if ($tabla > 0) {
			$etiquetas = array('id', 'idCiclo', 'idPensum', 'idPeriodo', 'idProgEstudio', 'idEmpleado', 'idSede', 'nom', 'cod');
			$campos = array('idGrupo', 'idCiclo', 'idPensum', 'idPeriodo', 'idProgEstudio', 'idEmpleado', 'idSede', 'nomGrupo', 'codGrupo');
