...
$aux = $opt; 
		$objDia = new Dia ();
		$tabla = $objDia->consultarDiaXidDia($aux);
		$objDia->cerrarConexion();
		if ($tabla > 0) {
			$etiquetas = array('id', 'nom', 'nomCorto', 'letra');
			$campos = array('idDia', 'nomDia', 'nomCortoDia', 'letraDia');
