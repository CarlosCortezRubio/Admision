 ...
 *  
 * Imprimir de la Tabla TipoEvaluac 
 * 
 * @author UNM 
 * @version V 0.1 
 * @date 08/12/2021
...
$aux = $opt; 
		...
		$tabla = $objTipoEvaluac->consultarTipoEvaluacXidTipoEvaluac($aux);
		$objTipoEvaluac->cerrarConexion();
		if ($tabla > 0) {
			$etiquetas = array('id', 'nom');
			$campos = array('idTipoEvaluac', 'nomTipoEvaluac');
