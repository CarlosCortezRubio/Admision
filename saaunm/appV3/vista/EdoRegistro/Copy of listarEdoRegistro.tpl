...
<script>
	function buscarRegistro(){
		...
		jQuery.ajax({
			...
			url: dominioJS+"base/EdoRegistro/datosTabla",        // Url to which the request is send
...
<!-- **************************************************************************		 -->
				<div class="form-group col-lg-12">
					<!-- Tab panes -->
					<div class="">
					  	<a href='{$URLSIST}base/encuesta/imprimir1' target='_blank'>
					  		<img width="40px;" class='classHand' onclick='xajax_clickEncuesta(\$campoClave,1)' src='{$PUB_URL}img/home/pdf.jpg' title='Consultar' border='0px'/>
					  	</a>
					  	{literal}
