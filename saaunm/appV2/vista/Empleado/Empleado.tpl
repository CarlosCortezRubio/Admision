...
validar('idPersona','IdPersona Empleado',REQUERIDO);
</script>
{/literal}
<div class='pagina'>
	<form name='form' id='form' method='post' action='{$valorForm}'>
		<div class='line-title'>
			<h4>{if $opt == 'g'} Agregar {elseif $opt == 'm' || $opt == 'mr'} Modificar {/if} Empleado</h4>
		</div>
		<a id='ancla' href='#'></a>
...
<div class="form-group col-lg-4">
	<label class="control-label">IdPersona Empleado</label>
	<div class="">
