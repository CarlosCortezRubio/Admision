...
validar('nomCortoAsignatura','Nombre Corto',REQUERIDO);
...
<div class="form-group col-lg-4">
	...
	<div class="">
		<input id='nomCortoAsignatura' name='nomCortoAsignatura' value='{$nomCortoAsignatura}' maxlength='64' class='form-control input-sm' />
	</div>
</div>
<div class="form-group col-lg-4">
	<label class="control-label">Práctica Laboral</label>
	<div class="">
		<select id='pracLabAsignatura' name='pracLabAsignatura' class='form-control input-sm'>
	<option value=''>-Seleccione-</option>
	{html_options options=$tablaPracLabAsignatura selected=$pracLabAsignatura}
</select>
	</div>
</div>
		</div>
