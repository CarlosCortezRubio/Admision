...
//		$this->visualizar('principal/error.tpl');
	...
	function datosTabla($request,$session){
        ...
        $etiquetas = array(
            ...
            "Imp",
            "Ver",
            "Editar","Id Curso","Periodo","Programa de Estudio","Estado","Docente","Pensum","Asignatura","Código","Nombre","Cupo Máximo","Fecha de Inicio","Fecha de Culminación"
        );
        ...
        $campos = array(
            ...
            "obj_" . $imgImp,
            "obj_" . $imgVer,
            "obj_" . $imgEdi,"idCurso","idPeriodo","idProgEstudio","idEdoRegistro","idEmpleado","idPensum","idAsignatura","codCurso","nomCurso","cupMaxCurso","fecIniCurso","fecFinCurso"
        );
