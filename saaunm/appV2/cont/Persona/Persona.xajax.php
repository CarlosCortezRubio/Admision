...
/* FIN PAGINACION */ 
			$etiquetas = array('','Imp','Ver','Editar','IDPERSONA','IDGENERO','IDEDOCIVIL','IDEDOREGISTRO');
		if ($resultado!=null) {
			...
			$campos = array('obj_' . $chk, 'obj_' . $img3,'obj_' . $img, 'obj_' . $img1,'IDPERSONA','IDGENERO','IDEDOCIVIL','IDEDOREGISTRO');
