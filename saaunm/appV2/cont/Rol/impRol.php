...
$aux = $opt; 
		$objRol = new Rol ();
		$tabla = $objRol->consultarRolXidRol($aux);
		$objRol->cerrarConexion();
		if ($tabla > 0) {
			$etiquetas = array('IDROL', 'Edo_idEdoRegistro', 'NOMROL', 'DESCROL');
			$campos = array('IDROL', 'Edo_idEdoRegistro', 'NOMROL', 'DESCROL');
