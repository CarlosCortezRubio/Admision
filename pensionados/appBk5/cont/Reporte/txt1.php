...
$periodo = $tablaDatos[0]['idPeriodo'];
$ipssTotal = $objPlanillaPensionado->consultarIpssXidTipoPlanillaYPeriodo($tipo,$periodo);
...
//     001706;2021;11;02;07;0001;
    ...
    $uniEjecutora = '001706';
    $correlativo = '0001';
    $nomArchivo = 'PLL'.$uniEjecutora.$anio.$mes.$tipPlanilla.$clasePlanilla.$correlativo.".txt";
...
//     die();
    ...
    $res = detallePlanilla($objArchivo,$resArchivo,$tablaDatos,$tabla,$anio,$mes,$tipo,$cantRegistros,$ipssTotal);
...
function detallePlanilla($objArchivo,$resArchivo,$detalleConceptos,$datosReporte,$anio,$mes,$tipo,$cantRegistros,$ipssTotal){
//     dump($detalleConceptos);die();
//     dump($detalleConceptos);
    $cantRegistros = count($detalleConceptos)+$cantRegistros*2;    
...
//     echo "Totalizando [$uniEjecutora.$anioActual.$mesActual.$tipPlanilla.$clasePlanilla.$correlativo.$cantRegistros.[$mntIng].[$mntEgr].$mntApo.$mntReint.$mntEncarg.$otrosIng] <br><br>";
    ...
    $otrosIng = number_format($otrosIng,2,'.','')."\r";
//     $mntIng = ($mntIng).';';
//     $mntEgr = ($mntEgr).';';
//     $mntApo = ($mntApo).';';
//     $mntReint = ($mntReint).';';
...
//                 $ipssPlanPensAnt = $ipssPlanPens;
                ...
                $cod44 = '9'.';';
                $cod55 = '9999'.';';
                $cod77 = $sumConceptos - $mntConcPlanilla."\r";
//                 echo "** cod77 = $cod77 <br>";
