...
// private $descRol;
	function principalRol(){
		parent::__construct ();		
		$this->campos = 'idRol,idEdoRegistro,nomRol,descRol';
		$this->modelo = 'Rol';
		$this->modulo = 'Rol';
	...
	function guardar($request,$session){
		...
		$objRol = new Rol ();
		$tablaResultado = $objRol->agregarRol($this->idRol,$this->idEdoRegistro,$this->nomRol,$this->descRol);
	...
	function actualizar($request,$session){
		$this->inicializarAtributos($request,$this->campos);
		$objRol = new Rol ();
		$tablaResultado = $objRol->actualizarRol($this->idRol,$this->idEdoRegistro,$this->nomRol,$this->descRol,$this->idRol);
		$objRol->cerrarConexion();
		if ($tablaResultado > 0) {
...
$this->inicializarCombos();		$objRol = new Rol ();
