...
<div id='paginacion1'></div>
        ...
        <script>
                ...
                gridPeriodo.setHeader('|Imp|Ver|Editar|Id|Estado|Año|Mes|Periodo|Observación');
                gridPeriodo.enableColumnAutoSize(true);
                gridPeriodo.setInitWidths('25|60|60|60|92|103|94|93|*|*');
                gridPeriodo.setColAlign('center|center|center|center|center|center|center|center|*|*');
//              gridPeriodo.attachEvent('onRowDblClicked',eliminarCondicion);
                gridPeriodo.setColTypes('ro|ro|ro|ro|ro|ro|ro|ro|ro|ro');
                gridPeriodo.setColSorting('str|str|str|str|int|int|int|int|str|str');
