...
<div class='pagina'>
	<form name='form' id='form' method='post' action='{$valorForm}'>
		<div class='line-title'>
			<h4>{if $opt == 'g'} Agregar {elseif $opt == 'm' || $opt == 'mr'} Modificar {/if} Planilla Pensionado</h4>
...
<!-- 								</div> -->
								...
								<div class="form-group col-lg-3">
									...
									<div class="">
										<input id='bancoPersona' name='bancoPersona' value='{$nomBanco}' class='form-control input-sm' readonly />
