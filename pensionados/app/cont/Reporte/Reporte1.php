...
//         $titulo = 'PLANILLAS DE PENSIONADOS';
        $titulo = 'Listado de Pagos de Pensiones';
        break;
    case 2:
...
//     $campos = array('CEDULA','APENOMTRAB','CUENTA','FECHACREACION');
    $campos = array('nro','docPersona','nom1Persona','totImpplanillaPensionado','totHabplanillaPensionado','totDescplanillaPensionado','totLiqplanillaPensionado');
