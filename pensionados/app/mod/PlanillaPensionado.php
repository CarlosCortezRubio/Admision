...
//         $idplanillaPensionado = parent::prepareParam($idplanillaPensionado, Query::DATATYPE_INTEGER);
    ...
    function consultarIpssXidTipoPlanillaYPeriodo($idTipoPlanilla,$idPeriodo){
        $params = array($idTipoPlanilla,$idPeriodo);
        $res = parent::executeQuery(SQLPlanillaPensionado::CONSULTAR_IPSS_POR_TIPOPLANILLA_Y_PERIODO, $params);
        $Ipss = $res[0]['Ipss'];
        return $Ipss;
    }
