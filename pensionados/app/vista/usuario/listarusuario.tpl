...
<div id='paginacion1'></div>
        ...
        <script>
                ...
                gridUsuario.setHeader('|Imp|Ver|Editar|Id|IdPersona|IdRol|IdEdoRegistro|Cuenta|Contrasena|FecCreacion|PregSecreta|RespPregSecreta');
                gridUsuario.enableColumnAutoSize(true);
                gridUsuario.setInitWidths('25|60|60|60|92|99|95|103|96|100|101|101|105');
