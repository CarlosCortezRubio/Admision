 ...
 *  
 * Imprimir de la Tabla TipoConcepto 
 * 
 * @author UNM 
 * @version V 0.1 
 * @date 16/10/2021
...
// $pdf->Encabezado();
$pdf->encabezado_def(60,null,'Tipo Concepto');
...
$tabla = $objTipoConcepto->consultarTipoConceptoXidTipoConcepto($aux);
