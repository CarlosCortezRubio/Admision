...
// private $descGenero;
	function principalGenero(){
		parent::__construct ();		
		$this->campos = 'idGenero,nomGenero,descGenero';
		$this->modelo = 'Genero';
		$this->modulo = 'Genero';
	...
	function guardar($request,$session){
		...
		$tablaResultado = $objGenero->agregarGenero($this->idGenero,$this->nomGenero,$this->descGenero);
	...
	function actualizar($request,$session){
		$this->inicializarAtributos($request,$this->campos);
		$objGenero = new Genero ();
		$tablaResultado = $objGenero->actualizarGenero($this->idGenero,$this->nomGenero,$this->descGenero,$this->idGenero);
		$objGenero->cerrarConexion();
		if ($tablaResultado > 0) {
