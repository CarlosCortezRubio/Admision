...
<div id='paginacion1'></div>
        ...
        <script>
                ...
                gridPeriodo.setHeader('|Imp|Ver|Editar|Id|Anio|Mes|Nom|Edo|Obs');
                gridPeriodo.enableColumnAutoSize(true);
                gridPeriodo.setInitWidths('25|60|60|60|92|94|93|93|93|93');
                gridPeriodo.setColAlign('center|center|center|center|right|right|right|left|right|left');
//              gridPeriodo.attachEvent('onRowDblClicked',eliminarCondicion);
                gridPeriodo.setColTypes('ro|ro|ro|ro|ro|ro|ro|ro|ro|ro');
                gridPeriodo.setColSorting('str|str|str|str|int|int|int|str|int|str');
