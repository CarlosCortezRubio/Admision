...
<input type="button" onclick="xajax_duplicar(xajax.$('idPeriodoOrigen').value,xajax.$('idPeriodo').value,xajax.$('anioPeriodo').value,xajax.$('mesPeriodo').value);" value="Duplicar" class="btn btn-primary">
</div>
		</fieldset>
	<br />
