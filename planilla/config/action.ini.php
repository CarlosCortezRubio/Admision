...
//			$this->setParameterPath ( 'LOGO_CLINICA', utf8_encode($_SESSION ['NOM_CLINICA']) );
		...
		// ******************** INICIO MANEJO DEL MENU DE LA NOMINA
		if (isset($_SESSION ['NOMINA_SEL_ID'])) {
		    if ($_SESSION ['NOMINA_SEL_ID']!='-1') {
		        $this->setParameter ( 'nominaSelId', $_SESSION ['NOMINA_SEL_ID']);
		        $this->setParameter ( 'nominaSelNom', $_SESSION ['NOMINA_SEL_NOMBRE']);
		        $this->setParameter ( 'actMenNom', true);
		    }else{
		        $this->setParameter ( 'nominaSelId', -1);
		        $this->setParameter ( 'nominaSelNom', '');
		        $this->setParameter ( 'actMenNom', false);
		    }
		}else{
		    $this->setParameter ( 'nominaSelId', -1);
		    $this->setParameter ( 'nominaSelNom', '');
		...
		// ******************** FIN MANEJO DEL MENU DE LA NOMINA
// 		die();
		//$this->setParameterPath ( 'MENU_USU', $_SESSION ['menuUsu'] );
