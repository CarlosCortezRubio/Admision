...
$aux = $opt; 
		...
		if ($tabla > 0) {
			$etiquetas = array('id', 'idRol', 'idPersona', 'idEdoRegistro', 'cuenta', 'contrasena', 'fecCreacion', 'pregSecreta', 'respPregSecreta');
			$campos = array('idUsuario', 'idRol', 'idPersona', 'idEdoRegistro', 'cuentaUsuario', 'contrasenaUsuario', 'fecCreacion', 'pregSecreta', 'respPregSecreta');
