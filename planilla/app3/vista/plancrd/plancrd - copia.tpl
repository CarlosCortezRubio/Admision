...
<div class="form-group col-lg-4">
	...
	<div class="">
		<input id='idPlanCrd' name='idPlanCrd' value='{$idPlanCrd}' maxlength='64' class='form-control input-sm' />
	</div>
</div>
<div class="form-group col-lg-4">
...
<div class="form-group col-lg-4">
	...
	<div class="">
		<input id='eraDocPlanCrd' name='eraDocPlanCrd' value='{$eraDocPlanCrd}' maxlength='64' class='form-control input-sm' />
	</div>
</div>
<div class="form-group col-lg-4">
	...
	<div class="">
		<input id='incDespPlanCrd' name='incDespPlanCrd' value='{$incDespPlanCrd}' maxlength='64' class='form-control input-sm' />
	</div>
</div>
<div class="form-group col-lg-4">
...
<div class="form-group col-lg-4">
	...
	<div class="">
		<input id='preGPlanCrd' name='preGPlanCrd' value='{$preGPlanCrd}' maxlength='64' class='form-control input-sm' />
	</div>
</div>
<div class="form-group col-lg-4">
	<label class="control-label">MAESTRÍA</label>
	<div class="">
		<input id='maePlanCrd' name='maePlanCrd' value='{$maePlanCrd}' maxlength='64' class='form-control input-sm' />
	</div>
</div>
<div class="form-group col-lg-4">
	<label class="control-label">DOCTORADO</label>
	<div class="">
		<input id='docPlanCrd' name='docPlanCrd' value='{$docPlanCrd}' maxlength='64' class='form-control input-sm' />
	</div>
</div>
<div class="form-group col-lg-4">
...
<div class="form-group col-lg-4">
	...
	<div class="">
		<input id='rzaInvPlanCrd' name='rzaInvPlanCrd' value='{$rzaInvPlanCrd}' maxlength='64' class='form-control input-sm' />
	</div>
</div>
<div class="form-group col-lg-4">
	<label class="control-label">DOCENTE REGISTRADO EN DINA</label>
	<div class="">
		<input id='enDinaPlanCrd' name='enDinaPlanCrd' value='{$enDinaPlanCrd}' maxlength='64' class='form-control input-sm' />
	</div>
</div>
<div class="form-group col-lg-4">
