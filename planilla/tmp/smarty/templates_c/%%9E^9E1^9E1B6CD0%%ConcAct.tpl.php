<?php /* Smarty version 2.6.30, created on 2021-09-22 22:12:08
         compiled from C:%5Claragon%5Cwww%5Cplanilla/app/vista/ConcAct/ConcAct.tpl */ ?>
<?php echo '
...
<div class="form-check col-lg-2">
	<input type='checkbox' id='p_del20530ConcAct' name='p_del20530ConcAct' value="1" <?php if ($this->_tpl_vars['p_del20530ConcAct'] == '1'): ?>checked<?php endif; ?> class='form-check-input' />
	<label class="form-check-label">P del20530</label>
</div>
<div class="form-check col-lg-2">
	<input type='checkbox' id='decreto_supermo_20_21ConcAct' name='decreto_supermo_20_21ConcAct' value="1" <?php if ($this->_tpl_vars['decreto_supermo_20_21ConcAct'] == '1'): ?>checked<?php endif; ?> class='form-check-input' />
