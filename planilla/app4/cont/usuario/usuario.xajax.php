...
/* FIN PAGINACION */ 
			$etiquetas = array('','Imp','Ver','Editar','Id','IdRol','IdPersona','IdEdoRegistro','Cuenta','Contrasena','FecCreacion','PregSecreta','RespPregSecreta');
		if ($resultado!=null) {
			...
			$campos = array('obj_' . $chk, 'obj_' . $img3,'obj_' . $img, 'obj_' . $img1,'idUsuario','idRol','idPersona','idEdoRegistro','cuentaUsuario','contrasenaUsuario','fecCreacion','pregSecreta','respPregSecreta');
