...
*/
define ( 'NOM_PROYECTO', "Registro de Docentes por período electivo V1" );					// Nombre de la aplicación (se muestra en la pestaña del navegador)
...
define ( 'NOMSIST', 'docentesv1' );				// Nombre de la carpeta que contiene la aplicación
define('CONSEGURA', 1);								// Establece si se va a trabajar con https (1) o no (0)
