...
/**
	function compAgregarcambiarTabla1cambiarTabla2($idPensum, $nomPensum) {
		$objcambiarTabla1 = new cambiarTabla1();
		$objcambiarTabla1->beginTransaction();
		$resultado1 = cambiarTabla1::agregarcambiarTabla1('aqui van los campos de tabla1');
		$idcambiarTabla1 = $objcambiarTabla1->consultarcambiarTabla1UltimoId();
		$resultado2 = cambiarTabla2::agregarcambiarTabla2($idPensum, $nomPensum, $id_Pensum);
	...
	function compActualizarcambiarTabla1cambiarTabla2($idPensum, $nomPensum) {
		$objcambiarTabla1 = new cambiarTabla1();
		$objcambiarTabla1->beginTransaction();
		$resultado1 = cambiarTabla1::actualizarcambiarTabla1('aqui van los campos de tabla1');
		$resultado2 = cambiarTabla2::actualizarcambiarTabla2($idPensum, $nomPensum, $id_Pensum);
		if ($resultado1>0 AND $resultado2>0) {
			cambiarTabla2::commitTransaction();
			$objcambiarTabla1->commitTransaction();
			cambiarTabla2::desconectar();
	...
	*/ 
	function agregarPensum($idPensum, $nomPensum) {
...
$nomPensum = parent::prepareParam($nomPensum, Query::DATATYPE_STRING, 0);
		...
		$params = array($idPensum, $nomPensum);
		return parent::execute(SQLPensum::AGREGAR_PENSUM, $params);
	}

	function actualizarPensum($idPensum, $nomPensum, $id_Pensum){
		
$idPensum = parent::prepareParam($idPensum, Query::DATATYPE_INTEGER);
$nomPensum = parent::prepareParam($nomPensum, Query::DATATYPE_STRING, 0);

		
		$params = array($idPensum, $nomPensum, $id_Pensum);
