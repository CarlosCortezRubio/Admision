...
/* FIN PAGINACION */ 
			$etiquetas = array('','Imp','Ver','Editar','Id','Ruc','Tel','Dir','Correo');
		if ($resultado!=null) {
			...
			$campos = array('obj_' . $chk, 'obj_' . $img3,'obj_' . $img, 'obj_' . $img1,'idEmpresa','rucEmpresa','telEmpresa','dirEmpresa','correoEmpresa');
