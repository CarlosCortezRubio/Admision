...
// private $nomPensum;
	function principalPensum(){
		parent::__construct ();		
		$this->campos = 'idPensum,nomPensum';
		$this->modelo = 'Pensum';
		$this->modulo = 'Pensum';
	...
	function guardar($request,$session){
		...
		$tablaResultado = $objPensum->agregarPensum($this->idPensum,$this->nomPensum);
	...
	function actualizar($request,$session){
		$this->inicializarAtributos($request,$this->campos);
		$objPensum = new Pensum ();
		$tablaResultado = $objPensum->actualizarPensum($this->idPensum,$this->nomPensum,$this->idPensum);
		$objPensum->cerrarConexion();
		if ($tablaResultado > 0) {
