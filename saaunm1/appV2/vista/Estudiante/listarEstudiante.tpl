...
<div id='paginacion1'></div>
        ...
        <script>
                ...
                gridEstudiante.setHeader('|Imp|Ver|Editar|Id|IDPERSONA|IdPeriodo|IdSede|IdProgEstudio');
                gridEstudiante.enableColumnAutoSize(true);
                gridEstudiante.setInitWidths('25|60|60|60|92|99|99|96|103');
                gridEstudiante.setColAlign('center|center|center|center|right|right|right|right|right');
//              gridEstudiante.attachEvent('onRowDblClicked',eliminarCondicion);
                gridEstudiante.setColTypes('ro|ro|ro|ro|ro|ro|ro|ro|ro');
                gridEstudiante.setColSorting('str|str|str|str|int|int|int|int|int');
