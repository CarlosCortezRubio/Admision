...
<div id='paginacion1'></div>
        ...
        <script>
                ...
                gridUsuario.setHeader('|Imp|Ver|Editar|IDUSUARIO|IDPERSONA|IDROL|IDEDOREGISTRO|CUENTAUSUARIO|CONTRASENAUSUARIO|FECCREACION|PREGSECRETA|RESPPREGSECRETA');
                gridUsuario.enableColumnAutoSize(true);
                gridUsuario.setInitWidths('25|60|60|60|99|99|95|103|103|107|101|101|105');
