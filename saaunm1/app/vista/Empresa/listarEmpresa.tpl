...
<div id='paginacion1'></div>
        ...
        <script>
                ...
                gridEmpresa.setHeader('|Imp|Ver|Editar|Id|Ruc|Tel|Dir|Correo');
                gridEmpresa.enableColumnAutoSize(true);
                gridEmpresa.setInitWidths('25|60|60|60|92|93|93|93|96');
                gridEmpresa.setColAlign('center|center|center|center|right|left|left|left|left');
//              gridEmpresa.attachEvent('onRowDblClicked',eliminarCondicion);
                gridEmpresa.setColTypes('ro|ro|ro|ro|ro|ro|ro|ro|ro');
                gridEmpresa.setColSorting('str|str|str|str|int|str|str|str|str');
