...
$aux = $opt; 
		...
		if ($tabla > 0) {
			$etiquetas = array('id', 'idTipo', 'idTipoEvaluac', 'IDEDOREGISTRO', 'cod', 'nom', 'pracLab');
			$campos = array('idAsignatura', 'idTipoAsignatura', 'idTipoEvaluac', 'IDEDOREGISTRO', 'codAsignatura', 'nomAsignatura', 'pracLabAsignatura');
