...
/* FIN PAGINACION */ 
			$etiquetas = array('','Imp','Ver','Editar','Id','IdEmpleado','IdSede','IdProgEstudio','IdPensum','IdAsignatura','IdPeriodo','Cod','Nom','CupMax','FecIni','FecFin');
		if ($resultado!=null) {
			...
			$campos = array('obj_' . $chk, 'obj_' . $img3,'obj_' . $img, 'obj_' . $img1,'idCurso','idEmpleado','idSede','idProgEstudio','idPensum','idAsignatura','idPeriodo','codCurso','nomCurso','cupMaxCurso','fecIniCurso','fecFinCurso');
