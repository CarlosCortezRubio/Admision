...
/* FIN PAGINACION */ 
			$etiquetas = array('','Imp','Ver','Editar','IDUSUARIO','IDPERSONA','IDROL','IDEDOREGISTRO','CUENTAUSUARIO','CONTRASENAUSUARIO','FECCREACION','PREGSECRETA','RESPPREGSECRETA');
		if ($resultado!=null) {
			...
			$campos = array('obj_' . $chk, 'obj_' . $img3,'obj_' . $img, 'obj_' . $img1,'IDUSUARIO','IDPERSONA','IDROL','IDEDOREGISTRO','CUENTAUSUARIO','CONTRASENAUSUARIO','FECCREACION','PREGSECRETA','RESPPREGSECRETA');
