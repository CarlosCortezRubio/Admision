...
/**
	function compAgregarcambiarTabla1cambiarTabla2($idEmpresa, $rucEmpresa, $telEmpresa, $dirEmpresa, $correoEmpresa) {
		$objcambiarTabla1 = new cambiarTabla1();
		$objcambiarTabla1->beginTransaction();
		$resultado1 = cambiarTabla1::agregarcambiarTabla1('aqui van los campos de tabla1');
		$idcambiarTabla1 = $objcambiarTabla1->consultarcambiarTabla1UltimoId();
		$resultado2 = cambiarTabla2::agregarcambiarTabla2($idEmpresa, $rucEmpresa, $telEmpresa, $dirEmpresa, $correoEmpresa, $id_Empresa);
	...
	function compActualizarcambiarTabla1cambiarTabla2($idEmpresa, $rucEmpresa, $telEmpresa, $dirEmpresa, $correoEmpresa) {
		$objcambiarTabla1 = new cambiarTabla1();
		$objcambiarTabla1->beginTransaction();
		$resultado1 = cambiarTabla1::actualizarcambiarTabla1('aqui van los campos de tabla1');
		$resultado2 = cambiarTabla2::actualizarcambiarTabla2($idEmpresa, $rucEmpresa, $telEmpresa, $dirEmpresa, $correoEmpresa, $id_Empresa);
		if ($resultado1>0 AND $resultado2>0) {
			cambiarTabla2::commitTransaction();
			$objcambiarTabla1->commitTransaction();
			cambiarTabla2::desconectar();
	...
	*/ 
	function agregarEmpresa($idEmpresa, $rucEmpresa, $telEmpresa, $dirEmpresa, $correoEmpresa) {
...
$correoEmpresa = parent::prepareParam($correoEmpresa, Query::DATATYPE_STRING, 0);
		...
		$params = array($idEmpresa, $rucEmpresa, $telEmpresa, $dirEmpresa, $correoEmpresa);
		return parent::execute(SQLEmpresa::AGREGAR_EMPRESA, $params);
	}

	function actualizarEmpresa($idEmpresa, $rucEmpresa, $telEmpresa, $dirEmpresa, $correoEmpresa, $id_Empresa){
...
$correoEmpresa = parent::prepareParam($correoEmpresa, Query::DATATYPE_STRING, 0);
		...
		$params = array($idEmpresa, $rucEmpresa, $telEmpresa, $dirEmpresa, $correoEmpresa, $id_Empresa);
