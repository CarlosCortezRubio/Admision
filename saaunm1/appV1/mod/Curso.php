...
/**
	function compAgregarcambiarTabla1cambiarTabla2($idCurso, $idEmpleado, $idSede, $idProgEstudio, $idPensum, $idAsignatura, $idPeriodo, $codCurso, $nomCurso, $cupMaxCurso, $fecIniCurso, $fecFinCurso) {
		$objcambiarTabla1 = new cambiarTabla1();
		$objcambiarTabla1->beginTransaction();
		$resultado1 = cambiarTabla1::agregarcambiarTabla1('aqui van los campos de tabla1');
		$idcambiarTabla1 = $objcambiarTabla1->consultarcambiarTabla1UltimoId();
		$resultado2 = cambiarTabla2::agregarcambiarTabla2($idCurso, $idEmpleado, $idSede, $idProgEstudio, $idPensum, $idAsignatura, $idPeriodo, $codCurso, $nomCurso, $cupMaxCurso, $fecIniCurso, $fecFinCurso, $id_Curso);
	...
	function compActualizarcambiarTabla1cambiarTabla2($idCurso, $idEmpleado, $idSede, $idProgEstudio, $idPensum, $idAsignatura, $idPeriodo, $codCurso, $nomCurso, $cupMaxCurso, $fecIniCurso, $fecFinCurso) {
		$objcambiarTabla1 = new cambiarTabla1();
		$objcambiarTabla1->beginTransaction();
		$resultado1 = cambiarTabla1::actualizarcambiarTabla1('aqui van los campos de tabla1');
		$resultado2 = cambiarTabla2::actualizarcambiarTabla2($idCurso, $idEmpleado, $idSede, $idProgEstudio, $idPensum, $idAsignatura, $idPeriodo, $codCurso, $nomCurso, $cupMaxCurso, $fecIniCurso, $fecFinCurso, $id_Curso);
		if ($resultado1>0 AND $resultado2>0) {
			cambiarTabla2::commitTransaction();
			$objcambiarTabla1->commitTransaction();
			cambiarTabla2::desconectar();
	...
	*/ 
	function agregarCurso($idCurso, $idEmpleado, $idSede, $idProgEstudio, $idPensum, $idAsignatura, $idPeriodo, $codCurso, $nomCurso, $cupMaxCurso, $fecIniCurso, $fecFinCurso) {
...
$cupMaxCurso = parent::prepareParam($cupMaxCurso, Query::DATATYPE_INTEGER);
		...
		$params = array($idCurso, $idEmpleado, $idSede, $idProgEstudio, $idPensum, $idAsignatura, $idPeriodo, $codCurso, $nomCurso, $cupMaxCurso, $fecIniCurso, $fecFinCurso);
		return parent::execute(SQLCurso::AGREGAR_CURSO, $params);
	}

	function actualizarCurso($idCurso, $idEmpleado, $idSede, $idProgEstudio, $idPensum, $idAsignatura, $idPeriodo, $codCurso, $nomCurso, $cupMaxCurso, $fecIniCurso, $fecFinCurso, $id_Curso){
...
$cupMaxCurso = parent::prepareParam($cupMaxCurso, Query::DATATYPE_INTEGER);
		...
		$params = array($idCurso, $idEmpleado, $idSede, $idProgEstudio, $idPensum, $idAsignatura, $idPeriodo, $codCurso, $nomCurso, $cupMaxCurso, $fecIniCurso, $fecFinCurso, $id_Curso);
...
//------------------------------	
	...
	function consultarCursoXidSede($idSede){	
		$params = array($idSede);
		return parent::executeQuery(SQLCurso::CONSULTAR_CURSO_POR_IDSEDE, $params);
	}	
	
	function existeCursoXidSede($idSede){
		$params = array($idSede);
		$tabla = parent::executeQuery(SQLCurso::CONSULTAR_CURSO_POR_IDSEDE, $params);
		if (count($tabla)>0) {
			return true;			
		}
		return false;
