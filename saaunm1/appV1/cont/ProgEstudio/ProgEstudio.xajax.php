...
/* FIN PAGINACION */ 
			$etiquetas = array('','Imp','Ver','Editar','Id','IdEmpleado','Cod','Nom','NumRes','FecRes','AplPreinsc','AplGrupo','NumResRev','FecResRev');
		if ($resultado!=null) {
			...
			$campos = array('obj_' . $chk, 'obj_' . $img3,'obj_' . $img, 'obj_' . $img1,'idProgEstudio','idEmpleado','codProgEstudio','nomProgEstudio','numResProgEstudio','fecResProgEstudio','aplPreinscProgEstudio','aplGrupoProgEstudio','numResRevProgEstudio','fecResRevProgEstudio');
