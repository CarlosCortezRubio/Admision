...
<div id='paginacion1'></div>
        ...
        <script>
                ...
                gridPensum.setHeader('|Imp|Ver|Editar|Id|Nom');
                gridPensum.enableColumnAutoSize(true);
                gridPensum.setInitWidths('25|60|60|60|92|93');
                gridPensum.setColAlign('center|center|center|center|right|left');
//              gridPensum.attachEvent('onRowDblClicked',eliminarCondicion);
                gridPensum.setColTypes('ro|ro|ro|ro|ro|ro');
                gridPensum.setColSorting('str|str|str|str|int|str');
