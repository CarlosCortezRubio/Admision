...
<div id='paginacion1'></div>
        ...
        <script>
                ...
                gridTipoSolicitud.setHeader('|Imp|Ver|Editar|Id|Sol|FecIni|FecFin|Seg');
                gridTipoSolicitud.enableColumnAutoSize(true);
                gridTipoSolicitud.setInitWidths('25|60|60|60|92|93|96|96|93');
                gridTipoSolicitud.setColAlign('center|center|center|center|right|left|left|left|right');
//              gridTipoSolicitud.attachEvent('onRowDblClicked',eliminarCondicion);
                gridTipoSolicitud.setColTypes('ro|ro|ro|ro|ro|ro|ro|ro|ro');
                gridTipoSolicitud.setColSorting('str|str|str|str|int|str|str|str|int');
