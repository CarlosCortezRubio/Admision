...
<div id='paginacion1'></div>
        ...
        <script>
                ...
                gridEdoRegistro.setHeader('|Imp|Ver|Editar|IDEDOREGISTRO|NOMEDOREGISTRO|DESCEDOREGISTRO|GPOEDOREGISTRO');
                gridEdoRegistro.enableColumnAutoSize(true);
                gridEdoRegistro.setInitWidths('25|60|60|60|103|104|105|104');
