...
<div id='paginacion1'></div>
        ...
        <script>
                ...
                gridProgEstudio.setHeader('|Imp|Ver|Editar|Id|IdEmpleado|Cod|Nom|NumRes|FecRes|AplPreinsc|AplGrupo|NumResRev|FecResRev');
                gridProgEstudio.enableColumnAutoSize(true);
                gridProgEstudio.setInitWidths('25|60|60|60|92|100|93|93|96|96|100|98|99|99');
                gridProgEstudio.setColAlign('center|center|center|center|right|right|left|left|left|left|right|right|left|left');
//              gridProgEstudio.attachEvent('onRowDblClicked',eliminarCondicion);
                ...
                gridProgEstudio.setColSorting('str|str|str|str|int|int|str|str|str|str|int|int|str|str');
