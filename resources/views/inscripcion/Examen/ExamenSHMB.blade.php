...
<form action="{{ route('evaluar', ['id_postulante' => $id_postulante]) }}" id="formevaluar" method="post">
    ...
    <div class='centrar-content col'>
        <div id="reproductor1" class="centrar-content ">
            <audio>
                <source src="{{ asset('audio/ExamenSHMB/P1.mp3') }}" type="audio/mp3">
            </audio>
                ...
                <div class='row'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta1 form-check-input" value="E" id="0105"
                            name="respuesta1">
                        <label class="respuesta1 form-check-label justify-content-center" for="0105">Solista Instrumental o vocal</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='row'>
    ...
    <div class='centrar-content col'>
        ...
        <div id="reproductor2" class="centrar-content ">
            <audio>
                <source src="{{ asset('audio/ExamenSHMB/P2.mp3') }}" type="audio/mp3">
            </audio>
                ...
                <div class='row'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta4 form-check-input" value="E" id="0405"
                            name="respuesta4">
                        <label class="respuesta4 form-check-label justify-content-center" for="0405">Solista
                ...
                <div class='row'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta4 form-check-input" value="F" id="0406"
                            name="respuesta4">
                        <label class="respuesta4 form-check-label justify-content-center" for="0406">Poema
                            sinfónico</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                ...
                <div class='row'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta4 form-check-input" value="I" id="0409"
                            name="respuesta4">
                        <label class="respuesta4 form-check-label justify-content-center" for="0409">Coral</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='row'>
                ...
                <div class='row'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta4 form-check-input" value="K" id="0411"
                            name="respuesta4">
                        <label class="respuesta4 form-check-label justify-content-center" for="0411">Misa</label>
                    </div>
                    <div class='col-1'></div>
                </div>
            </div>
                ...
                <div class='row'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="form-check-input respuesta5" value="K" id="0511"
                            name="respuesta5">
                        <label class="respuesta5 form-check-label justify-content-center" for="0511">Banda
                            militar</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                ...
                <div class='row'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta6 form-check-input" value="A" id="0601"
                            name="respuesta6">
                        <label class="respuesta6 form-check-label justify-content-center" for="0601">Edad
                            media</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='row'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta6 form-check-input" value="B" id="0602"
                            name="respuesta6">
                        <label class="respuesta6 form-check-label justify-content-center"
                            for="0602">Renacimiento</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='row'>
    ...
    <div class="row form-group">
        ...
        <div class='col-1 pregunta centrar-content' id='pregunta7'>
            <h5><label style="text-align: center;">Barroco</label></h5>
        </div>
        <div class="col">
            <div class='row'>
                <div class='col'>
                    ...
                    <div class="form-check  col" style="height: 100%;">
                        <input type="checkbox" class="respuesta7 form-check-input" value="A" id="0701"
                            name="respuesta7[]">
                        <label class="respuesta7 form-check-label justify-content-center"
                            for="0701">Cuarteto de cuerdas</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col'>
                ...
                <div class='col'>
                    ...
                    <div class="form-check col" style="height: 100%;">
                        <input type="checkbox" class="respuesta7 form-check-input" value="C" id="0703"
                            name="respuesta7[]">
                        <label class="respuesta7 form-check-label justify-content-center" for="0703">Bajo continuo</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col'>
                ...
                <div class='col'>
                    ...
                    <div class="form-check col" style="height: 100%;">
                        <input type="checkbox" class="respuesta7 form-check-input" value="G" id="0706"
                            name="respuesta7[]">
                        <label class="respuesta7 form-check-label justify-content-center" for="0706">Clavecín</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col'>
                    ...
                    <div class="form-check col" style="height: 100%;">
                        <input type="checkbox" class="respuesta7 form-check-input" value="H" id="0707"
                            name="respuesta7[]">
                        <label class="respuesta7 form-check-label justify-content-center" for="0707">Forma Sonata</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col'>
                    ...
                    <div class="form-check col" style="height: 100%;">
                        <input type="checkbox" class="respuesta7 form-check-input" value="I" id="0708"
                            name="respuesta7[]">
                        <label class="respuesta7 form-check-label justify-content-center" for="0708">Música programática</label>
                    </div>
                    <div class='col-1'></div>
                </div>
            </div>
    ...
    <div class="row form-group">
        ...
        <div class='col-1 pregunta centrar-content' id='pregunta8'>
            <h5><label style="text-align: center;">Impresionismo</label></h5>
        </div>
        <div class="col">
            <div class='row'>
                <div class='col'>
                    ...
                    <div class="form-check  col" style="height: 100%;">
                        <input type="checkbox" class="respuesta8 form-check-input" value="A" id="0801"
                            name="respuesta8[]">
                        <label class="respuesta8 form-check-label justify-content-center" for="0801">A. Berg</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col'>
                    ...
                    <div class="form-check col" style="height: 100%;">
                        <input type="checkbox" class="respuesta8 form-check-input" value="B" id="0802"
                            name="respuesta8[]">
                        <label class="respuesta8 form-check-label justify-content-center" for="0802">Colores tímbricos</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col'>
                    ...
                    <div class="form-check col" style="height: 100%;">
                        <input type="checkbox" class="respuesta8 form-check-input" value="C" id="0803"
                            name="respuesta8[]">
                        <label class="respuesta8 form-check-label justify-content-center" for="0803">Disonancias sin resolver</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col'>
                    ...
                    <div class="form-check col" style="height: 100%;">
                        <input type="checkbox" class="respuesta8 form-check-input" value="D" id="0804"
                            name="respuesta8[]">
                        <label class="respuesta8 form-check-label justify-content-center" for="0804">E. Satie</label>
                    </div>
                    <div class='col-1'></div>
                </div>
            </div>
                ...
                <div class='col'>
                    ...
                    <div class="form-check col" style="height: 100%;">
                        <input type="checkbox" class="respuesta8 form-check-input" value="F" id="0805"
                            name="respuesta8[]">
                        <label class="respuesta8 form-check-label justify-content-center" for="0805">Cadencias claras</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col'>
                    ...
                    <div class="form-check col" style="height: 100%;">
                        <input type="checkbox" class="respuesta8 form-check-input" value="G" id="0806"
                            name="respuesta8[]">
                        <label class="respuesta8 form-check-label justify-content-center" for="0806">Armonía modulante</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col'>
                    ...
                    <div class="form-check col" style="height: 100%;">
                        <input type="checkbox" class="respuesta8 form-check-input" value="H" id="0807"
                            name="respuesta8[]">
                        <label class="respuesta8 form-check-label justify-content-center" for="0807">Atonalidad.</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col'>
                    ...
                    <div class="form-check col" style="height: 100%;">
                        <input type="checkbox" class="respuesta8 form-check-input" value="I" id="0808"
                            name="respuesta8[]">
                        <label class="respuesta8 form-check-label justify-content-center" for="0808">Dodecafonismo</label>
                    </div>
                    <div class='col-1'></div>
                </div>
            </div>
