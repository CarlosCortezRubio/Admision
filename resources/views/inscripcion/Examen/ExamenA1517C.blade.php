...
<form action="{{ route('evaluar', ['id_postulante' => $id_postulante]) }}" id="formevaluar" method="post">
    ...
    <h5>Marque la opción correcta por cada intervalo (Cada intervalo sonará tres veces)</h5>
    <div class='row centrar-content col'>
        <div id="reproductor1" class="centrar-content ">
            <audio>
                <source src="{{ asset('audio/ExamenA1517C/P1.mp3') }}" type="audio/mp3">
            </audio>
            ...
            <div class='row'>
                ...
                <div class='col-4'>
                    <div class="form-check col">
                        ...
                        <label class="respuesta1 form-check-label justify-content-center" for="0107">6m</label>
                    </div>
                </div>
                <div class='col-4'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta1 form-check-input" value="H" id="0108" name="respuesta1">
                        <label class="respuesta1 form-check-label justify-content-center" for="0108">6M</label>
                    </div>
                </div>
                <div class='col-4'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta1 form-check-input" value="I" id="0109" name="respuesta1">
                        <label class="respuesta1 form-check-label justify-content-center" for="0109">8J</label>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class='col-4'>
                    <div class="form-check col">
                        ...
                        <label class="respuesta2 form-check-label justify-content-center" for="0207">6m</label>
                    </div>
                </div>
                <div class='col-4'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta2 form-check-input" value="H" id="0208" name="respuesta2">
                        <label class="respuesta2 form-check-label justify-content-center" for="0208">6M</label>
                    </div>
                </div>
                <div class='col-4'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta2 form-check-input" value="I" id="0209" name="respuesta2">
                        <label class="respuesta2 form-check-label justify-content-center" for="0209">8J</label>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class='row'>
                ...
                <div class='col-4'>
                    <div class="form-check col">
                        ...
                        <label class="respuesta3 form-check-label justify-content-center" for="0307">6m</label>
                    </div>
                </div>
                <div class='col-4'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta3 form-check-input" value="H" id="0308" name="respuesta3">
                        <label class="respuesta3 form-check-label justify-content-center" for="0308">6M</label>
                    </div>
                </div>
                <div class='col-4'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta3 form-check-input" value="I" id="0309" name="respuesta3">
                        <label class="respuesta3 form-check-label justify-content-center" for="0309">8J</label>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class='row'>
                ...
                <div class='col-4'>
                    <div class="form-check col">
                        ...
                        <label class="respuesta4 form-check-label justify-content-center" for="0407">6m</label>
                    </div>
                </div>
                <div class='col-4'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta4 form-check-input" value="H" id="0408" name="respuesta4">
                        <label class="respuesta4 form-check-label justify-content-center" for="0408">6M</label>
                    </div>
                </div>
                <div class='col-4'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta4 form-check-input" value="I" id="0409" name="respuesta4">
                        <label class="respuesta4 form-check-label justify-content-center" for="0409">8J</label>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class='row'>
                ...
                <div class='col-4'>
                    <div class="form-check col">
                        ...
                        <label class="respuesta5 form-check-label justify-content-center" for="0507">6m</label>
                    </div>
                </div>
                <div class='col-4'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta5 form-check-input" value="H" id="0508" name="respuesta5">
                        <label class="respuesta5 form-check-label justify-content-center" for="0508">6M</label>
                    </div>
                </div>
                <div class='col-4'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta5 form-check-input" value="I" id="0509" name="respuesta5">
                        <label class="respuesta5 form-check-label justify-content-center" for="0509">8J</label>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class='row'>
                ...
                <div class='col-4'>
                    <div class="form-check col">
                        ...
                        <label class="respuesta6 form-check-label justify-content-center" for="0607">6m</label>
                    </div>
                </div>
                <div class='col-4'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta6 form-check-input" value="H" id="0608" name="respuesta6">
                        <label class="respuesta6 form-check-label justify-content-center" for="0608">6M</label>
                    </div>
                </div>
                <div class='col-4'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta6 form-check-input" value="I" id="0609" name="respuesta6">
                        <label class="respuesta6 form-check-label justify-content-center" for="0609">8J</label>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class='centrar-content col'>
        <div id="reproductor2" class="centrar-content ">
            <audio>
                <source src="{{ asset('audio/ExamenA1517C/P2.mp3') }}" type="audio/mp3">
            </audio>
            ...
            <div class='row'>
                ...
                <div class='col-6'>
                    <div class="form-check col">
                        ...
                        <label class="respuesta7 form-check-label justify-content-center" for="0703">A</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta7 form-check-input" value="D" id="0704" name="respuesta7">
                        <label class="respuesta7 form-check-label justify-content-center" for="0704">d</label>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class='row'>
                ...
                <div class='col-6'>
                    <div class="form-check col">
                        ...
                        <label class="respuesta8 form-check-label justify-content-center" for="0803">A</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta8 form-check-input" value="D" id="0804" name="respuesta8">
                        <label class="respuesta8 form-check-label justify-content-center" for="0804">d</label>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class='row'>
                ...
                <div class='col-6'>
                    <div class="form-check col">
                        ...
                        <label class="respuesta9 form-check-label justify-content-center" for="0903">A</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta9 form-check-input" value="D" id="0904" name="respuesta9">
                        <label class="respuesta9 form-check-label justify-content-center" for="0904">d</label>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row form-group">
        ...
        <div class="col">
            <div class='row'>
                ...
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta10 form-check-input" value="C" id="1003" name="respuesta10">
                        <label class="respuesta10 form-check-label justify-content-center" for="1003">A</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta10 form-check-input" value="D" id="1004" name="respuesta10">
                        <label class="respuesta10 form-check-label justify-content-center" for="1004">d</label>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row form-group">
        ...
        <div class="col">
            <div class='row'>
                ...
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta11 form-check-input" value="C" id="1103" name="respuesta11">
                        <label class="respuesta11 form-check-label justify-content-center" for="1103">A</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta11 form-check-input" value="D" id="1104" name="respuesta11">
                        <label class="respuesta11 form-check-label justify-content-center" for="1104">d</label>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row form-group">
        ...
        <div class="col">
            <div class='row'>
                ...
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta12 form-check-input" value="C" id="1203" name="respuesta12">
                        <label class="respuesta12 form-check-label justify-content-center" for="1203">A</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta12 form-check-input" value="D" id="1204" name="respuesta12">
                        <label class="respuesta12 form-check-label justify-content-center" for="1204">d</label>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class='centrar-content col'>
        <div id="reproductor3" class="centrar-content ">
            <audio>
                <source src="{{ asset('audio/ExamenA1517C/P3A.mp3') }}" type="audio/mp3">
            </audio>
            ...
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta13 form-check-label justify-content-center" for="1301"> <img
                            src="{{ asset('imagen/ExamenA1517C/P3AA.png') }}" alt=""
            ...
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta13 form-check-label justify-content-center" for="1302"> <img
                            src="{{ asset('imagen/ExamenA1517C/P3AB.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta13 form-check-label justify-content-center" for="1303"> <img
                            src="{{ asset('imagen/ExamenA1517C/P3AC.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta13 form-check-label justify-content-center" for="1304"> <img
                            src="{{ asset('imagen/ExamenA1517C/P3AD.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
    ...
    <div class='centrar-content col'>
        <div id="reproductor4" class="centrar-content ">
            <audio>
                <source src="{{ asset('audio/ExamenA1517C/P3B.mp3') }}" type="audio/mp3">
            </audio>
            ...
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta14 form-check-label justify-content-center" for="1401"> <img
                            src="{{ asset('imagen/ExamenA1517C/P3BA.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta14 form-check-label justify-content-center" for="1402"> <img
                            src="{{ asset('imagen/ExamenA1517C/P3BB.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta14 form-check-label justify-content-center" for="1403"> <img
                            src="{{ asset('imagen/ExamenA1517C/P3BC.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta14 form-check-label justify-content-center" for="1404"> <img
                            src="{{ asset('imagen/ExamenA1517C/P3BD.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
    ...
    <div class='centrar-content col'>
        <div id="reproductor5" class="centrar-content ">
            <audio>
                <source src="{{ asset('audio/ExamenA1517C/P4A.mp3') }}" type="audio/mp3">
            </audio>
            ...
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta15 form-check-label justify-content-center" for="1501"> <img
                            src="{{ asset('imagen/ExamenA1517C/P4AA.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta15 form-check-label justify-content-center" for="1502"> <img
                            src="{{ asset('imagen/ExamenA1517C/P4AB.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta15 form-check-label justify-content-center" for="1503"> <img
                            src="{{ asset('imagen/ExamenA1517C/P4AC.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta15 form-check-label justify-content-center" for="1504"> <img
                            src="{{ asset('imagen/ExamenA1517C/P4AD.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
    ...
    <div class='centrar-content col'>
        <div id="reproductor6" class="centrar-content ">
            <audio>
                <source src="{{ asset('audio/ExamenA1517C/P4B.mp3') }}" type="audio/mp3">
            </audio>
            ...
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta16 form-check-label justify-content-center" for="1601"> <img
                            src="{{ asset('imagen/ExamenA1517C/P4BA.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta16 form-check-label justify-content-center" for="1602"> <img
                            src="{{ asset('imagen/ExamenA1517C/P4BB.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta16 form-check-label justify-content-center" for="1603"> <img
                            src="{{ asset('imagen/ExamenA1517C/P4BC.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta16 form-check-label justify-content-center" for="1604"> <img
                            src="{{ asset('imagen/ExamenA1517C/P4BD.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
