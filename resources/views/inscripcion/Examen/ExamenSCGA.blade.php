...
<form action="{{ route('evaluar', ['id_postulante' => $id_postulante,'cod_examen' => session('examen')]) }}" id="formevaluar" method="post">
    ...
    <div class="form-group">
        <div class='pregunta' id='pregunta1'>
            <h5><label>1.  ¿Quien fue el inventor de la dinamita?</label></h5>
        </div>
        <div class='container'>
            <div class='row'>
                <div class='col-1'></div>
                <div class="form-check  col">
                    ...
                    <label class="respuesta1 form-check-label" for="0101">a) Albert Einstein</label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta1 form-check-label" for="0102">b) Alfred Nobel</label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta1 form-check-label" for="0103">c) Benjamin Franklin</label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta1 form-check-label" for="0104">d) Jang Yeong-Sil</label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta1 form-check-label" for="0105">e) María Beasley</label>
                </div>
                <div class='col-1'></div>
            </div>
        </div>
    ...
    <div class="form-group">
        <div class='pregunta' id='pregunta2'>
            <h5><label>2.	¿Quién escribió La palabra del mudo?</label></h5>
        </div>
        <div class='container'>
            <div class='row'>
                <div class='col-1'></div>
                <div class="form-check col">
                    ...
                    <label class="form-check-label" for="0201">a) César Vallejo</label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="form-check-label " for="0202">b) Ciro Alegría</label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="form-check-label" for="0203">c) Julio Ramón Ribeyro</label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="form-check-label" for="0204">d) Eleodoro Vargas Vicuña</label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="form-check-label" for="0205">e) José María Arguedas</label>
                </div>
                <div class='col-1'></div>
            </div>
        </div>
    ...
    <div class="form-group">
        <div class='pregunta' id='pregunta3'>
            <h5><label>3. ¿En qué año estalló la bomba atómica en Hiroshima y Nagasaki?</label></h5>
        </div>
        <div class='container'>
            <div class='row'>
                <div class='col'>
                    <div class='row'>
                        ...
                        <div class="form-check col">
                            ...
                            <label class="respuesta3 form-check-label" for="0301">a) 1945</label>
                        </div>
                    </div>
                    <div class='row'>
                        <div class='col-1'></div>
                        <div class="form-check col">
                            ...
                            <label class="respuesta3 form-check-label" for="0302">b) 1944</label>
                        </div>
                    </div>
                    <div class='row'>
                        <div class='col-1'></div>
                        <div class="form-check col">
                            ...
                            <label class="respuesta3 form-check-label" for="0303">c) 1946</label>
                        </div>
                    </div>
                    <div class='row'>
                        <div class='col-1'></div>
                        <div class="form-check col">
                            ...
                            <label class="respuesta3 form-check-label" for="0304">d) 1943</label>
                        </div>
                    </div>
                    <div class='row'>
                        <div class='col-1'></div>
    ...
    <div class="form-group">
        <div class='pregunta' id='pregunta4'>
            <h5><label>4. ¿Quién pintó Las Meninas?</label></h5>
        </div>
        <div class='container'>
            <div class='row'>
                <div class='col-1'></div>
                <div class="form-check col">
                    ...
                    <label class="form-check-label" for="0401">a) Francisco de Zurbarán</label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="form-check-label " for="0402">b) Francisco de Goya</label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="form-check-label" for="0403">c) El Greco</label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="form-check-label" for="0404">d) Joaquín Sorolla</label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="form-check-label" for="0405">e) Diego Velázquez</label>
                </div>
                <div class='col-1'></div>
            </div>
        </div>
