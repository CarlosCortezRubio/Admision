...
<form action="{{ route('evaluar', ['id_postulante' => $id_postulante]) }}" id="formevaluar" method="post">
    ...
    <div class="row">
        <div class="col-1"></div>
        <div class="col"><img src=" {{ asset('imagen/ExamenT1214A/P1A.png') }}" alt=""
            ...
            <div class='row'>
                ...
                <div class='col-6'>
                    <div class="form-check col">
                        ...
                        <label class="respuesta1 form-check-label justify-content-center" for="0102">4J</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta1 form-check-input" value="C" id="0103" name="respuesta1">
                        <label class="respuesta1 form-check-label justify-content-center" for="0103">4A</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta1 form-check-input" value="D" id="0104" name="respuesta1">
                        <label class="respuesta1 form-check-label justify-content-center" for="0104">5d</label>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class='col-6'>
                    <div class="form-check col">
                        ...
                        <label class="respuesta2 form-check-label justify-content-center" for="0201">8J</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                ...
                <div class='col-6'>
                    <div class="form-check col">
                        ...
                        <label class="respuesta2 form-check-label justify-content-center" for="0203">7A</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta2 form-check-input" value="D" id="0204" name="respuesta2">
                        <label class="respuesta2 form-check-label justify-content-center" for="0204">7M</label>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class='row'>
                <div class='col-6'>
                    ...
                    <div class="form-check  col">
                        ...
                        <label class="respuesta3 form-check-label justify-content-center" for="0301">6m</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta3 form-check-label justify-content-center" for="0302">6A</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta3 form-check-label justify-content-center" for="0303">6M</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta3 form-check-label justify-content-center" for="0304">7m</label>
                    </div>
                    <div class='col-1'></div>
                </div>
            </div>
            ...
            <div class='row'>
                <div class='col-6'>
                    ...
                    <div class="form-check  col">
                        ...
                        <label class="respuesta4 form-check-label justify-content-center" for="0401">5d</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta4 form-check-label justify-content-center" for="0402">5J</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta4 form-check-label justify-content-center" for="0403">4d</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta4 form-check-label justify-content-center" for="0404">5A</label>
                    </div>
                    <div class='col-1'></div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-1"></div>
        <div class="col"><img src=" {{ asset('imagen/ExamenT1214A/P1B.png') }}" alt=""
                style="height:100%; width:100%;"></div>
        <div class="col-1"></div>
    </div>
    <br>
            ...
            <div class='row'>
                <div class='col-6'>
                    <div class="form-check  col">
                        ...
                        <label class="respuesta5 form-check-label justify-content-center" for="0501">3d</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                ...
                <div class='col-6'>
                    <div class="form-check col">
                        ...
                        <label class="respuesta5 form-check-label justify-content-center" for="0503">2d</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta5 form-check-input" value="D" id="0504" name="respuesta5">
                        <label class="respuesta5 form-check-label justify-content-center" for="0504">2m</label>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class='col-6'>
                    <div class="form-check col">
                        ...
                        <label class="respuesta6 form-check-label justify-content-center" for="0601">3M</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta6 form-check-input" value="B" id="0602" name="respuesta6">
                        <label class="respuesta6 form-check-label justify-content-center" for="0602">3m</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta6 form-check-input" value="C" id="0603" name="respuesta6">
                        <label class="respuesta6 form-check-label justify-content-center" for="0603">3A</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta6 form-check-input" value="D" id="0604" name="respuesta6">
                        <label class="respuesta6 form-check-label justify-content-center" for="0604">4d</label>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class='row'>
                <div class='col-6'>
                    ...
                    <div class="form-check  col">
                        ...
                        <label class="respuesta7 form-check-label justify-content-center" for="0701">7d</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta7 form-check-label justify-content-center" for="0702">7M</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta7 form-check-label justify-content-center" for="0703">7m</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta7 form-check-label justify-content-center" for="0704">8J</label>
                    </div>
                    <div class='col-1'></div>
                </div>
            </div>
            ...
            <div class='row'>
                <div class='col-6'>
                    ...
                    <div class="form-check  col">
                        ...
                        <label class="respuesta8 form-check-label justify-content-center" for="0801">3A</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta4 form-check-label justify-content-center" for="0802">3m</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta8 form-check-label justify-content-center" for="0803">3d</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta8 form-check-label justify-content-center" for="0804">3M</label>
                    </div>
                    <div class='col-1'></div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-1"></div>
        <div class="col"><img src=" {{ asset('imagen/ExamenT1214A/P2A.png') }}" alt=""
                style="height:100%; width:100%;"></div>
        <div class="col-1"></div>
    </div>
    <div class="row form-group">
            ...
            <div class='row'>
                <div class='col-6'>
                    ...
                    <div class="form-check  col">
                        ...
                        <label class="respuesta9 form-check-label justify-content-center" for="0901">Re mayor</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta9 form-check-label justify-content-center" for="0902">Re menor antigua o natural</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta9 form-check-label justify-content-center" for="0903">Re menor armónica</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta9 form-check-label justify-content-center" for="0904">Re menor melódica ascendente</label>
                    </div>
                    <div class='col-1'></div>
                </div>
            </div>
                ...
                <div class='col-6'>
                    ...
                    <div class="form-check  col">
                        <input type="radio" class="respuesta10 form-check-input" value="A" id="1001"
                            name="respuesta10">
                        <label class="respuesta10 form-check-label justify-content-center" for="1001">Sol mayor</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta10 form-check-input" value="B" id="1002"
                            name="respuesta10">
                        <label class="respuesta10 form-check-label justify-content-center" for="1002">Sol menor antigua o natural</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta10 form-check-input" value="C" id="1003"
                            name="respuesta10">
                        <label class="respuesta10 form-check-label justify-content-center" for="1003">Sol menor armónica</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta10 form-check-input" value="D" id="1004"
                            name="respuesta10">
                        <label class="respuesta10 form-check-label justify-content-center" for="1004">Sol menor melódica ascendente</label>
                    </div>
                    <div class='col-1'></div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-1"></div>
        <div class="col"><img src=" {{ asset('imagen/ExamenT1214A/P2B.png') }}" alt=""
                style="height:100%; width:100%;"></div>
        <div class="col-1"></div>
    </div>
    <div class="row form-group">
                ...
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta11 form-check-input" value="B" id="1102"
                            name="respuesta11">
                        <label class="respuesta11 form-check-label justify-content-center" for="1102">Do menor antigua o natural</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta11 form-check-input" value="C" id="1103"
                            name="respuesta11">
                        <label class="respuesta11 form-check-label justify-content-center" for="1103">Do menor armónica</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta11 form-check-input" value="D" id="1104"
                            name="respuesta11">
                        <label class="respuesta11 form-check-label justify-content-center" for="1104">Do menor melódica ascendente</label>
                    </div>
                    <div class='col-1'></div>
                </div>
            </div>
                ...
                <div class='col-6'>
                    ...
                    <div class="form-check  col">
                        <input type="radio" class="respuesta12 form-check-input" value="A" id="1201"
                            name="respuesta12">
                        <label class="respuesta12 form-check-label justify-content-center" for="1201">La mayor</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta12 form-check-input" value="B" id="1202"
                            name="respuesta12">
                        <label class="respuesta12 form-check-label justify-content-center" for="1202">La menor antigua o natural</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta12 form-check-input" value="C" id="1203"
                            name="respuesta12">
                        <label class="respuesta12 form-check-label justify-content-center" for="1203">La menor armónica</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta12 form-check-input" value="D" id="1204"
                            name="respuesta12">
                        <label class="respuesta12 form-check-label justify-content-center" for="1204">La menor melódica ascendente</label>
                    </div>
                    <div class='col-1'></div>
                </div>
            </div>
    ...
    <label class="respuesta13 form-check-label justify-content-center" for="1303"> <img
            src=" {{ asset('imagen/ExamenT1214A/P3A.png') }}" alt="" style="height:100%; width:100%;"></label>
        ...
        <div class='container'>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta13 form-check-label justify-content-center" for="1301"> <img
                            src=" {{ asset('imagen/ExamenT1214A/P3AA.png') }}" alt=""
            ...
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta13 form-check-label justify-content-center" for="1302"> <img
                            src=" {{ asset('imagen/ExamenT1214A/P3AB.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta13 form-check-label justify-content-center" for="1303"> <img
                            src=" {{ asset('imagen/ExamenT1214A/P3AC.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta13 form-check-label justify-content-center" for="1304"> <img
                            src=" {{ asset('imagen/ExamenT1214A/P3AD.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
    ...
    <label class="respuesta14 form-check-label justify-content-center" for="1401"> <img
            src=" {{ asset('imagen/ExamenT1214A/P3B.png') }}" alt="" style="height:100%; width:100%;"></label>
        ...
        <div class='container'>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta14 form-check-label justify-content-center" for="1401"> <img
                            src=" {{ asset('imagen/ExamenT1214A/P3BA.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta14 form-check-label justify-content-center" for="1402"> <img
                            src=" {{ asset('imagen/ExamenT1214A/P3BB.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta14 form-check-label justify-content-center" for="1403"> <img
                            src=" {{ asset('imagen/ExamenT1214A/P3BC.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta14 form-check-label justify-content-center" for="1404"> <img
                            src=" {{ asset('imagen/ExamenT1214A/P3BD.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
    ...
    <label class="respuesta15 form-check-label justify-content-center" for="1501"> <img
            src=" {{ asset('imagen/ExamenT1214A/P4A.png') }}" alt="" style="height:100%; width:100%;"></label>
                ...
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta15 form-check-input" value="C" id="1503"
                            name="respuesta15">
                        <label class="respuesta15 form-check-label justify-content-center" for="1503">Aumentada</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                ...
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta16 form-check-input" value="C" id="1603"
                            name="respuesta16">
                        <label class="respuesta16 form-check-label justify-content-center" for="1603">Aumentada</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                ...
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta17 form-check-input" value="C" id="1703"
                            name="respuesta17">
                        <label class="respuesta17 form-check-label justify-content-center" for="1703">Aumentada</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
    ...
    <label class="respuesta18 form-check-label justify-content-center" for="1801"> <img
            src=" {{ asset('imagen/ExamenT1214A/P4B.png') }}" alt="" style="height:100%; width:100%;"></label>
                ...
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta18 form-check-input" value="C" id="1803"
                            name="respuesta18">
                        <label class="respuesta18 form-check-label justify-content-center" for="1803">Aumentada</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
            ...
            <div class="row">
                ...
                <div class='col-6'>
                    <div class="form-check col">
                        ...
                        <label class="respuesta19 form-check-label justify-content-center" for="1903">Aumentada</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                ...
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta20 form-check-input" value="C" id="2003"
                            name="respuesta20">
                        <label class="respuesta20 form-check-label justify-content-center" for="2003">Aumentada</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
