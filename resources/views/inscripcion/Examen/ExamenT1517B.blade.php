<div id='title'>
    ...
    <h4>Programa Escolar de 15 a 17 años</h4>
...
<form action="{{ route('evaluar', ['id_postulante' => $id_postulante,'cod_examen' => session('examen')]) }}" id="formevaluar" method="post">
    ...
    <div class="row">
        <div class="col-1"></div>
        <div class="col"><img src=" {{ asset('imagen/ExamenT1517B/P1A.png') }}" alt=""
            ...
            <div class='row'>
                ...
                <div class='col-6'>
                    <div class="form-check col">
                        ...
                        <label class="respuesta1 form-check-label justify-content-center" for="0103">5A</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta1 form-check-input" value="D" id="0104" name="respuesta1">
                        <label class="respuesta1 form-check-label justify-content-center" for="0104">12J</label>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class='col-6'>
                    <div class="form-check col">
                        ...
                        <label class="respuesta2 form-check-label justify-content-center" for="0201">9m</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta2 form-check-input" value="B" id="0202" name="respuesta2">
                        <label class="respuesta2 form-check-label justify-content-center" for="0202">9M</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta2 form-check-input" value="C" id="0203" name="respuesta2">
                        <label class="respuesta2 form-check-label justify-content-center" for="0203">9d</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta2 form-check-input" value="D" id="0204" name="respuesta2">
                        <label class="respuesta2 form-check-label justify-content-center" for="0204">9A</label>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class='row'>
                ...
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta3 form-check-label justify-content-center" for="0303">7d</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta3 form-check-label justify-content-center" for="0304">7A</label>
                    </div>
                    <div class='col-1'></div>
                </div>
            </div>
            ...
            <div class='row'>
                ...
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta4 form-check-label justify-content-center" for="0403">2d</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta4 form-check-label justify-content-center" for="0404">2A</label>
                    </div>
                    <div class='col-1'></div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-1"></div>
        <div class="col"><img src=" {{ asset('imagen/ExamenT1517B/P1B.png') }}" alt=""
                style="height:100%; width:100%;"></div>
        <div class="col-1"></div>
    </div>
    <br>
            ...
            <div class="row">
                ...
                <div class='col-6'>
                    <div class="form-check col">
                        ...
                        <label class="respuesta6 form-check-label justify-content-center" for="0602">6M</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta6 form-check-input" value="C" id="0603" name="respuesta6">
                        <label class="respuesta6 form-check-label justify-content-center" for="0603">6d</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
            ...
            <div class='row'>
                <div class='col-6'>
                    ...
                    <div class="form-check  col">
                        ...
                        <label class="respuesta7 form-check-label justify-content-center" for="0701">11J</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta7 form-check-label justify-content-center" for="0702">11d</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta7 form-check-label justify-content-center" for="0703">11A</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta7 form-check-label justify-content-center" for="0704">4J</label>
                    </div>
                    <div class='col-1'></div>
                </div>
            </div>
            ...
            <div class='row'>
                <div class='col-6'>
                    ...
                    <div class="form-check  col">
                        ...
                        <label class="respuesta8 form-check-label justify-content-center" for="0801">10m</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta4 form-check-label justify-content-center" for="0802">10M</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta8 form-check-label justify-content-center" for="0803">10d</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta8 form-check-label justify-content-center" for="0804">10A</label>
                    </div>
                    <div class='col-1'></div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-1"></div>
        <div class="col"><img src=" {{ asset('imagen/ExamenT1517B/P2A.png') }}" alt=""
                style="height:100%; width:100%;"></div>
        <div class="col-1"></div>
    </div>
    <div class="row form-group">
    ...
    <div class="row">
        <div class="col-1"></div>
        <div class="col"><img src=" {{ asset('imagen/ExamenT1517B/P2B.png') }}" alt=""
                style="height:100%; width:100%;"></div>
        <div class="col-1"></div>
    </div>
    <div class="row form-group">
    ...
    <label class="respuesta13 form-check-label justify-content-center" for="1303"> <img
            src=" {{ asset('imagen/ExamenT1517B/P3A.png') }}" alt="" style="height:100%; width:100%;"></label>
        ...
        <div class='container'>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta13 form-check-label justify-content-center" for="1301"> <img
                            src=" {{ asset('imagen/ExamenT1517B/P3AA.png') }}" alt=""
            ...
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta13 form-check-label justify-content-center" for="1302"> <img
                            src=" {{ asset('imagen/ExamenT1517B/P3AB.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta13 form-check-label justify-content-center" for="1303"> <img
                            src=" {{ asset('imagen/ExamenT1517B/P3AC.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta13 form-check-label justify-content-center" for="1304"> <img
                            src=" {{ asset('imagen/ExamenT1517B/P3AD.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
    ...
    <label class="respuesta14 form-check-label justify-content-center" for="1401"> <img
            src=" {{ asset('imagen/ExamenT1517B/P3B.png') }}" alt="" style="height:100%; width:100%;"></label>
        ...
        <div class='container'>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta14 form-check-label justify-content-center" for="1401"> <img
                            src=" {{ asset('imagen/ExamenT1517B/P3BA.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta14 form-check-label justify-content-center" for="1402"> <img
                            src=" {{ asset('imagen/ExamenT1517B/P3BB.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta14 form-check-label justify-content-center" for="1403"> <img
                            src=" {{ asset('imagen/ExamenT1517B/P3BC.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta14 form-check-label justify-content-center" for="1404"> <img
                            src=" {{ asset('imagen/ExamenT1517B/P3BD.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
    ...
    <label class="respuesta15 form-check-label justify-content-center" for="1501"> <img
            src=" {{ asset('imagen/ExamenT1517B/P4A.png') }}" alt="" style="height:100%; width:100%;"></label>
    ...
    <label class="respuesta18 form-check-label justify-content-center" for="1801"> <img
            src=" {{ asset('imagen/ExamenT1517B/P4B.png') }}" alt="" style="height:100%; width:100%;"></label>
