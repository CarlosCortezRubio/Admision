    ...
    <form action="{{ route('evaluar', ['id_postulante' => $id_postulante]) }}" id="formevaluar" method="post">
        ...
        <div class='row centrar-content col'>
            <div id="reproductor1" class="centrar-content ">
                <audio>
                    <source src="{{ asset('audio/ExamenA1214D/P1.mp3') }}" type="audio/mp3">  
                </audio>
        ...
        <div class="row form-group">
            ...
            <div class='col'>
                <div class="row">
                    ...
                    <div class='col-4'>
                        <div class="form-check col">
                            <input type="radio" class="respuesta2 form-check-input" value="C" id="0203"
                                name="respuesta2">
                    ...
                    <div class='col-4'>
                        <div class="form-check col">
                            <input type="radio" class="respuesta2 form-check-input" value="D" id="0204"
                                name="respuesta2">
                    ...
                    <div class='col-4'>
                        <div class='col-1'></div>
                        <div class="form-check col">
                            <input type="radio" class="respuesta2 form-check-input" value="E" id="0205"
                                name="respuesta2">
                    ...
                    <div class='col-4'>
                        <div class="form-check col">
                            <input type="radio" class="respuesta2 form-check-input" value="F" id="0206"
                                name="respuesta2">
            ...
            <div class="col">
                <div class='row'>
                    ...
                    <div class='col-4'>
                        <div class='col-1'></div>
                        <div class="form-check col">
                            <input type="radio" class="respuesta3 form-check-input" value="E" id="0305"
                                name="respuesta3">
                    ...
                    <div class='col-4'>
                        <div class='col-1'></div>
                        <div class="form-check col">
                            <input type="radio" class="respuesta3 form-check-input" value="F" id="0306"
                                name="respuesta3">
            ...
            <div class="col">
                <div class='row'>
                    ...
                    <div class='col-4'>
                        <div class='col-1'></div>
                        <div class="form-check col">
                            <input type="radio" class="respuesta5 form-check-input" value="C" id="0503"
                                name="respuesta5">
                    ...
                    <div class='col-4'>
                        <div class='col-1'></div>
                        <div class="form-check col">
                            <input type="radio" class="respuesta5 form-check-input" value="D" id="0504"
                                name="respuesta5">
                    ...
                    <div class='col-4'>
                        <div class='col-1'></div>
                        <div class="form-check col">
                            <input type="radio" class="respuesta5 form-check-input" value="E" id="0505"
                                name="respuesta5">
                    ...
                    <div class='col-4'>
                        <div class='col-1'></div>
                        <div class="form-check col">
                            <input type="radio" class="respuesta5 form-check-input" value="F" id="0506"
                                name="respuesta5">
            ...
            <div class="col">
                <div class='row'>
                    ...
                    <div class='col-4'>
                        <div class='col-1'></div>
                        <div class="form-check col">
                            <input type="radio" class="respuesta6 form-check-input" value="C" id="0603"
                                name="respuesta6">
                    ...
                    <div class='col-4'>
                        <div class='col-1'></div>
                        <div class="form-check col">
                            <input type="radio" class="respuesta6 form-check-input" value="D" id="0604"
                                name="respuesta6">
                    ...
                    <div class='col-4'>
                        <div class='col-1'></div>
                        <div class="form-check col">
                            <input type="radio" class="respuesta6 form-check-input" value="E" id="0605"
                                name="respuesta6">
                    ...
                    <div class='col-4'>
                        <div class='col-1'></div>
                        <div class="form-check col">
                            <input type="radio" class="respuesta6 form-check-input" value="F" id="0606"
                                name="respuesta6">
        ...
        <div class='centrar-content col'>
            <div id="reproductor2" class="centrar-content ">
                <audio>
                    <source src="{{ asset('audio/ExamenA1214D/P2.mp3') }}" type="audio/mp3">
                </audio>
            ...
            <div class="col">
                <div class='row'>
                    <div class='col-6'>
                        <div class='col-1'></div>
                        <div class="form-check  col">
                            <input type="radio" class="respuesta7 form-check-input" value="A" id="0701"
                                name="respuesta7">
                    ...
                    <div class='col-6'>
                        <div class='col-1'></div>
                        <div class="form-check col">
                            <input type="radio" class="respuesta7 form-check-input" value="B" id="0702"
                                name="respuesta7">
            ...
            <div class="col">
                <div class='row'>
                    <div class='col-6'>
                        <div class='col-1'></div>
                        <div class="form-check  col">
                            <input type="radio" class="respuesta8 form-check-input" value="A" id="0801"
                                name="respuesta8">
                    ...
                    <div class='col-6'>
                        <div class='col-1'></div>
                        <div class="form-check col">
                            <input type="radio" class="respuesta8 form-check-input" value="B" id="0802"
                                name="respuesta8">
            ...
            <div class="col">
                <div class='row'>
                    <div class='col-6'>
                        <div class='col-1'></div>
                        <div class="form-check  col">
                            <input type="radio" class="respuesta9 form-check-input" value="A" id="0901"
                                name="respuesta9">
                    ...
                    <div class='col-6'>
                        <div class='col-1'></div>
                        <div class="form-check col">
                            <input type="radio" class="respuesta9 form-check-input" value="B" id="0902"
                                name="respuesta9">
        ...
        <div class='centrar-content col'>
            <div id="reproductor3" class="centrar-content ">
                <audio>
                    <source src="{{ asset('audio/ExamenA1214D/P3A.mp3') }}" type="audio/mp3">
                </audio>
        ...
        <div class="form-group">
            ...
            <div class='container'>
                <div class='row'>
                    <div class='col-1'></div>
                    <div class="form-check col">
                        <input type="radio" class="respuesta13 form-check-input" value="A" id="1301"
                            name="respuesta13">
                        <label class="respuesta13 form-check-label justify-content-center" for="1301"> <img
                                src="{{ asset('imagen/ExamenA1214D/P3AA.png') }}" alt=""
                ...
                <div class='row'>
                    <div class='col-1'></div>
                    <div class="form-check col">
                        <input type="radio" class="respuesta13 form-check-input" value="B" id="1302"
                            name="respuesta13">
                        <label class="respuesta13 form-check-label justify-content-center" for="1302"> <img
                                src="{{ asset('imagen/ExamenA1214D/P3AB.png') }}" alt=""
                                style="height:100%; width:100%;"></label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='row'>
                    <div class='col-1'></div>
                    <div class="form-check col">
                        <input type="radio" class="form-check-input respuesta13" value="C" id="1303"
                            name="respuesta13">
                        <label class="respuesta13 form-check-label justify-content-center" for="1303"> <img
                                src="{{ asset('imagen/ExamenA1214D/P3AC.png') }}" alt=""
                                style="height:100%; width:100%;"></label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='row'>
                    <div class='col-1'></div>
                    <div class="form-check col">
                        <input type="radio" class="form-check-input respuesta13" value="D" id="1304"
                            name="respuesta13">
                        <label class="respuesta13 form-check-label justify-content-center" for="1304"> <img
                                src="{{ asset('imagen/ExamenA1214D/P3AD.png') }}" alt=""
                                style="height:100%; width:100%;"></label>
                    </div>
                    <div class='col-1'></div>
                </div>
        ...
        <div class='centrar-content col'>
            <div id="reproductor4" class="centrar-content ">
                <audio>
                    <source src="{{ asset('audio/ExamenA1214D/P3B.mp3') }}" type="audio/mp3">
                </audio>
        ...
        <div class="form-group">
            ...
            <div class='container'>
                <div class='row'>
                    <div class='col-1'></div>
                    <div class="form-check col">
                        <input type="radio" class="respuesta14 form-check-input" value="A" id="1401"
                            name="respuesta14">
                        <label class="respuesta14 form-check-label justify-content-center" for="1401"> <img
                                src="{{ asset('imagen/ExamenA1214D/P3BA.png') }}" alt=""
                                style="height:100%; width:100%;"></label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='row'>
                    <div class='col-1'></div>
                    <div class="form-check col">
                        <input type="radio" class="respuesta14 form-check-input" value="B" id="1402"
                            name="respuesta14">
                        <label class="respuesta14 form-check-label justify-content-center" for="1402"> <img
                                src="{{ asset('imagen/ExamenA1214D/P3BB.png') }}" alt=""
                                style="height:100%; width:100%;"></label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='row'>
                    <div class='col-1'></div>
                    <div class="form-check col">
                        <input type="radio" class="form-check-input respuesta14" value="C" id="1403"
                            name="respuesta14">
                        <label class="respuesta14 form-check-label justify-content-center" for="1403"> <img
                                src="{{ asset('imagen/ExamenA1214D/P3BC.png') }}" alt=""
                                style="height:100%; width:100%;"></label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='row'>
                    <div class='col-1'></div>
                    <div class="form-check col">
                        <input type="radio" class="form-check-input respuesta14" value="D" id="1404"
                            name="respuesta14">
                        <label class="respuesta14 form-check-label justify-content-center" for="1404"> <img
                                src="{{ asset('imagen/ExamenA1214D/P3BD.png') }}" alt=""
                                style="height:100%; width:100%;"></label>
                    </div>
                    <div class='col-1'></div>
                </div>
        ...
        <div class='centrar-content col'>
            <div id="reproductor5" class="centrar-content ">
                <audio>
                    <source src="{{ asset('audio/ExamenA1214D/P4A.mp3') }}" type="audio/mp3">
                </audio>
        ...
        <div class="form-group">
            ...
            <div class='container'>
                <div class='row'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta15 form-check-label justify-content-center" for="1501"> <img
                                src="{{ asset('imagen/ExamenA1214D/P4AA.png') }}" alt=""
                                style="height:100%; width:100%;"></label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='row'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta15 form-check-label justify-content-center" for="1502"> <img
                                src="{{ asset('imagen/ExamenA1214D/P4AB.png') }}" alt=""
                                style="height:100%; width:100%;"></label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='row'>
                    <div class='col-1'></div>
                    <div class="form-check col">
                        <input type="radio" class="form-check-input respuesta15" value="C" id="1503"
                            name="respuesta15">
                        <label class="respuesta15 form-check-label justify-content-center" for="1503"> <img
                                src="{{ asset('imagen/ExamenA1214D/P4AC.png') }}" alt=""
                                style="height:100%; width:100%;"></label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='row'>
                    <div class='col-1'></div>
                    <div class="form-check col">
                        <input type="radio" class="form-check-input respuesta15" value="D" id="1504"
                            name="respuesta15">
                        <label class="respuesta15 form-check-label justify-content-center" for="1504"> <img
                                src="{{ asset('imagen/ExamenA1214D/P4AD.png') }}" alt=""
                                style="height:100%; width:100%;"></label>
                    </div>
                    <div class='col-1'></div>
                </div>
        ...
        <div class='centrar-content col'>
            <div id="reproductor6" class="centrar-content ">
                <audio>
                    <source src="{{ asset('audio/ExamenA1214D/P4B.mp3') }}" type="audio/mp3"> 
                </audio>
        ...
        <div class="form-group">
            ...
            <div class='container'>
                <div class='row'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta16 form-check-label justify-content-center" for="1601"> <img
                                src="{{ asset('imagen/ExamenA1214D/P4BA.png') }}" alt=""
                                style="height:100%; width:100%;"></label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='row'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta16 form-check-label justify-content-center" for="1602"> <img
                                src="{{ asset('imagen/ExamenA1214D/P4BB.png') }}" alt=""
                                style="height:100%; width:100%;"></label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='row'>
                    <div class='col-1'></div>
                    <div class="form-check col">
                        <input type="radio" class="form-check-input respuesta16" value="C" id="1603"
                            name="respuesta16">
                        <label class="respuesta16 form-check-label justify-content-center" for="1603"> <img
                                src="{{ asset('imagen/ExamenA1214D/P4BC.png') }}" alt=""
                                style="height:100%; width:100%;"></label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='row'>
                    <div class='col-1'></div>
                    <div class="form-check col">
                        <input type="radio" class="form-check-input respuesta16" value="D" id="1604"
                            name="respuesta16">
                        <label class="respuesta16 form-check-label justify-content-center" for="1604"> <img
                                src="{{ asset('imagen/ExamenA1214D/P4BD.png') }}" alt=""
                                style="height:100%; width:100%;"></label>
                    </div>
                    <div class='col-1'></div>
                </div>
