...
<form action="{{ route('evaluar', ['id_postulante' => $id_postulante]) }}" id="formevaluar" method="post">
    ...
    <div class="row">
        <div class="col-1"></div>
        <div class="col"><img src=" {{ asset('imagen/ExamenPTD/P1A.png') }}" alt=""
            ...
            <div class='row'>
                <div class='col-6'>
                    <div class="form-check  col">
                        ...
                        <label class="respuesta1 form-check-label justify-content-center" for="0101">6m</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta1 form-check-input" value="B" id="0102" name="respuesta1">
                        <label class="respuesta1 form-check-label justify-content-center" for="0102">7m</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta1 form-check-input" value="C" id="0103" name="respuesta1">
                        <label class="respuesta1 form-check-label justify-content-center" for="0103">6M</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta1 form-check-input" value="D" id="0104" name="respuesta1">
                        <label class="respuesta1 form-check-label justify-content-center" for="0104">6A</label>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class='col-6'>
                    <div class="form-check col">
                        ...
                        <label class="respuesta2 form-check-label justify-content-center" for="0201">7m</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta2 form-check-input" value="B" id="0202" name="respuesta2">
                        <label class="respuesta2 form-check-label justify-content-center" for="0202">7M</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta2 form-check-input" value="C" id="0203" name="respuesta2">
                        <label class="respuesta2 form-check-label justify-content-center" for="0203">6M</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta2 form-check-input" value="D" id="0204" name="respuesta2">
                        <label class="respuesta2 form-check-label justify-content-center" for="0204">7d</label>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class='row'>
                <div class='col-6'>
                    ...
                    <div class="form-check  col">
                        ...
                        <label class="respuesta3 form-check-label justify-content-center" for="0301">3M</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta3 form-check-label justify-content-center" for="0302">4J</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                ...
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta3 form-check-label justify-content-center" for="0304">4d</label>
                    </div>
                    <div class='col-1'></div>
                </div>
            </div>
            ...
            <div class='row'>
                <div class='col-6'>
                    ...
                    <div class="form-check  col">
                        ...
                        <label class="respuesta4 form-check-label justify-content-center" for="0401">5A</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta4 form-check-label justify-content-center" for="0402">4J</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                ...
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta4 form-check-label justify-content-center" for="0404">5d</label>
                    </div>
                    <div class='col-1'></div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-1"></div>
        <div class="col"><img src=" {{ asset('imagen/ExamenPTD/P1B.png') }}" alt=""
                style="height:100%; width:100%;"></div>
        <div class="col-1"></div>
    </div>
    <br>
            ...
            <div class='row'>
                <div class='col-6'>
                    <div class="form-check  col">
                        ...
                        <label class="respuesta5 form-check-label justify-content-center" for="0501">4d</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta5 form-check-input" value="B" id="0502" name="respuesta5">
                        <label class="respuesta5 form-check-label justify-content-center" for="0502">3M</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta5 form-check-input" value="C" id="0503" name="respuesta5">
                        <label class="respuesta5 form-check-label justify-content-center" for="0503">4J</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta5 form-check-input" value="D" id="0504" name="respuesta5">
                        <label class="respuesta5 form-check-label justify-content-center" for="0504">5d</label>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class='col-6'>
                    <div class="form-check col">
                        ...
                        <label class="respuesta6 form-check-label justify-content-center" for="0601">8J</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                ...
                <div class='col-6'>
                    <div class="form-check col">
                        ...
                        <label class="respuesta6 form-check-label justify-content-center" for="0603">8A</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta6 form-check-input" value="D" id="0604" name="respuesta6">
                        <label class="respuesta6 form-check-label justify-content-center" for="0604">8d</label>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class='row'>
                <div class='col-6'>
                    ...
                    <div class="form-check  col">
                        ...
                        <label class="respuesta7 form-check-label justify-content-center" for="0701">6m</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta7 form-check-label justify-content-center" for="0702">6M</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta7 form-check-label justify-content-center" for="0703">5J</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta7 form-check-label justify-content-center" for="0704">6A</label>
                    </div>
                    <div class='col-1'></div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-1"></div>
        <div class="col"><img src=" {{ asset('imagen/ExamenPTD/P2A.png') }}" alt=""
                style="height:100%; width:100%;"></div>
        <div class="col-1"></div>
    </div>
    <div class="row form-group">
            ...
            <div class='row'>
                <div class='col-6'>
                    ...
                    <div class="form-check  col">
                        ...
                        <label class="respuesta9 form-check-label justify-content-center" for="0901">Si Mayor</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta9 form-check-label justify-content-center" for="0902">Si Menor antigua o
                            natural</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta9 form-check-label justify-content-center" for="0903">Si Menor
                            armónica</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta9 form-check-label justify-content-center" for="0904">Si Menor melódica
                            ascendente</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                ...
                <div class='col-6'>
                    ...
                    <div class="form-check  col">
                        <input type="radio" class="respuesta10 form-check-input" value="A" id="1001"
                            name="respuesta10">
                        <label class="respuesta10 form-check-label justify-content-center" for="1001">Mib Mayor</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta10 form-check-input" value="B" id="1002"
                            name="respuesta10">
                        <label class="respuesta10 form-check-label justify-content-center" for="1002">Mib Menor antigua
                            o natural</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta10 form-check-input" value="C" id="1003"
                            name="respuesta10">
                        <label class="respuesta10 form-check-label justify-content-center" for="1003">Mib Menor
                            armónica</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta10 form-check-input" value="D" id="1004"
                            name="respuesta10">
                        <label class="respuesta10 form-check-label justify-content-center" for="1004">Mib Menor melódica
                            ascendente</label>
                    </div>
                    <div class='col-1'></div>
                </div>
    ...
    <div class="row">
        <div class="col-1"></div>
        <div class="col"><img src=" {{ asset('imagen/ExamenPTD/P2B.png') }}" alt=""
                style="height:100%; width:100%;"></div>
        <div class="col-1"></div>
    </div>
    <div class="row form-group">
                ...
                <div class='col-6'>
                    ...
                    <div class="form-check  col">
                        <input type="radio" class="respuesta11 form-check-input" value="A" id="1101"
                            name="respuesta11">
                        <label class="respuesta11 form-check-label justify-content-center" for="1101">Do Mayor</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta11 form-check-input" value="B" id="1102"
                            name="respuesta11">
                        <label class="respuesta11 form-check-label justify-content-center" for="1102">Do Menor antigua
                            o natural</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta11 form-check-input" value="C" id="1103"
                            name="respuesta11">
                        <label class="respuesta11 form-check-label justify-content-center" for="1103">Do Menor
                            armónica</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta11 form-check-input" value="D" id="1104"
                            name="respuesta11">
                        <label class="respuesta11 form-check-label justify-content-center" for="1104">Do Menor melódica
                            ascendente</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                ...
                <div class='col-6'>
                    ...
                    <div class="form-check  col">
                        <input type="radio" class="respuesta12 form-check-input" value="A" id="1201"
                            name="respuesta12">
                        <label class="respuesta12 form-check-label justify-content-center" for="1201">Sol Mayor</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta12 form-check-input" value="B" id="1202"
                            name="respuesta12">
                        <label class="respuesta12 form-check-label justify-content-center" for="1202">Sol Menor antigua
                            o natural</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta12 form-check-input" value="C" id="1203"
                            name="respuesta12">
                        <label class="respuesta12 form-check-label justify-content-center" for="1203">Sol Menor
                            armónica</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta12 form-check-input" value="D" id="1204"
                            name="respuesta12">
                        <label class="respuesta12 form-check-label justify-content-center" for="1204">Sol Menor melódica
                            ascendente</label>
                    </div>
                    <div class='col-1'></div>
                </div>
    ...
    <label class="respuesta13 form-check-label justify-content-center" for="1303"> <img
            src=" {{ asset('imagen/ExamenPTD/P3A.png') }}" alt="" style="height:100%; width:100%;"></label>
        ...
        <div class='container'>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta13 form-check-label justify-content-center" for="1301"> <img
                            src=" {{ asset('imagen/ExamenPTD/P3AA.png') }}" alt=""
            ...
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta13 form-check-label justify-content-center" for="1302"> <img
                            src=" {{ asset('imagen/ExamenPTD/P3AB.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta13 form-check-label justify-content-center" for="1303"> <img
                            src=" {{ asset('imagen/ExamenPTD/P3AC.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta13 form-check-label justify-content-center" for="1304"> <img
                            src=" {{ asset('imagen/ExamenPTD/P3AD.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
    ...
    <label class="respuesta14 form-check-label justify-content-center" for="1401"> <img
            src=" {{ asset('imagen/ExamenPTD/P3B.png') }}" alt="" style="height:100%; width:100%;"></label>
        ...
        <div class='container'>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta14 form-check-label justify-content-center" for="1401"> <img
                            src=" {{ asset('imagen/ExamenPTD/P3BA.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta14 form-check-label justify-content-center" for="1402"> <img
                            src=" {{ asset('imagen/ExamenPTD/P3BB.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta14 form-check-label justify-content-center" for="1403"> <img
                            src=" {{ asset('imagen/ExamenPTD/P3BC.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta14 form-check-label justify-content-center" for="1404"> <img
                            src=" {{ asset('imagen/ExamenPTD/P3BD.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
    ...
    <label class="respuesta15 form-check-label justify-content-center" for="1501"> <img
            src=" {{ asset('imagen/ExamenPTD/P4A.png') }}" alt="" style="height:100%; width:100%;"></label>
                ...
                <div class='col-6'>
                    <div class="form-check  col">
                        <input type="radio" class="respuesta15 form-check-input" value="A" id="1501"
                            name="respuesta15">
                        <label class="respuesta15 form-check-label justify-content-center" for="1501">La mayor</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta15 form-check-input" value="B" id="1502"
                            name="respuesta15">
                        <label class="respuesta15 form-check-label justify-content-center" for="1502">La menor</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta15 form-check-input" value="C" id="1503"
                            name="respuesta15">
                        <label class="respuesta15 form-check-label justify-content-center" for="1503">La aumentado</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                ...
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta16 form-check-input" value="A" id="1601"
                            name="respuesta16">
                        <label class="respuesta16 form-check-label justify-content-center" for="1601">Fa# mayor</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta16 form-check-input" value="B" id="1602"
                            name="respuesta16">
                        <label class="respuesta16 form-check-label justify-content-center" for="1602">Fa# menor</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta16 form-check-input" value="C" id="1603"
                            name="respuesta16">
                        <label class="respuesta16 form-check-label justify-content-center" for="1603">Fa# aumentado</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                ...
                <div class='col-6'>
                    ...
                    <div class="form-check  col">
                        <input type="radio" class="respuesta17 form-check-input" value="A" id="1701"
                            name="respuesta17">
                        <label class="respuesta17 form-check-label justify-content-center" for="1701">Do# mayor</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta17 form-check-input" value="B" id="1702"
                            name="respuesta17">
                        <label class="respuesta17 form-check-label justify-content-center" for="1702">Do# menor</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta17 form-check-input" value="C" id="1703"
                            name="respuesta17">
                        <label class="respuesta17 form-check-label justify-content-center" for="1703">Do# aumentado</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
    ...
    <label class="respuesta18 form-check-label justify-content-center" for="1801"> <img
            src=" {{ asset('imagen/ExamenPTD/P4B.png') }}" alt="" style="height:100%; width:100%;"></label>
                ...
                <div class='col-6'>
                    <div class="form-check  col">
                        <input type="radio" class="respuesta18 form-check-input" value="A" id="1801"
                            name="respuesta18">
                        <label class="respuesta18 form-check-label justify-content-center" for="1801">Fa# mayor</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta18 form-check-input" value="B" id="1802"
                            name="respuesta18">
                        <label class="respuesta18 form-check-label justify-content-center" for="1802">Fa# menor</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta18 form-check-input" value="C" id="1803"
                            name="respuesta18">
                        <label class="respuesta18 form-check-label justify-content-center" for="1803">Fa# aumentado</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                ...
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta19 form-check-input" value="A" id="1901"
                            name="respuesta19">
                        <label class="respuesta19 form-check-label justify-content-center" for="1901">Mb mayor</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta19 form-check-input" value="B" id="1902"
                            name="respuesta19">
                        <label class="respuesta19 form-check-label justify-content-center" for="1902">Mib menor</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta2 form-check-input" value="C" id="1903" name="respuesta19">
                        <label class="respuesta19 form-check-label justify-content-center" for="1903">Mib aumentado</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                ...
                <div class='col-6'>
                    ...
                    <div class="form-check  col">
                        <input type="radio" class="respuesta20 form-check-input" value="A" id="2001"
                            name="respuesta20">
                        <label class="respuesta20 form-check-label justify-content-center" for="2001">Re mayor</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta20 form-check-input" value="B" id="2002"
                            name="respuesta20">
                        <label class="respuesta20 form-check-label justify-content-center" for="2002">Re menor</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta20 form-check-input" value="C" id="2003"
                            name="respuesta20">
                        <label class="respuesta20 form-check-label justify-content-center" for="2003">Re aumentado</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
