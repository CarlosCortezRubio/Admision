...
<form action="{{ route('evaluar', ['id_postulante' => $id_postulante,'cod_examen' => session('examen')]) }}" id="formevaluar" method="post">
    ...
    <div class="row">
        <div class="col-1"></div>
        <div class="col"><img src=" {{ asset('imagen/ExamenT1214B/P1A.png') }}" alt=""
            ...
            <div class='row'>
                ...
                <div class='col-6'>
                    <div class="form-check col">
                        ...
                        <label class="respuesta1 form-check-label justify-content-center" for="0102">6m</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta1 form-check-input" value="C" id="0103" name="respuesta1">
                        <label class="respuesta1 form-check-label justify-content-center" for="0103">6d</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
            ...
            <div class="row">
                <div class='col-6'>
                    <div class="form-check col">
                        ...
                        <label class="respuesta2 form-check-label justify-content-center" for="0201">4A</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta2 form-check-input" value="B" id="0202" name="respuesta2">
                        <label class="respuesta2 form-check-label justify-content-center" for="0202">5J</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
            ...
            <div class='row'>
                <div class='col-6'>
                    ...
                    <div class="form-check  col">
                        ...
                        <label class="respuesta3 form-check-label justify-content-center" for="0301">7m</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta3 form-check-label justify-content-center" for="0302">7M</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta3 form-check-label justify-content-center" for="0303">7A</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta3 form-check-label justify-content-center" for="0304">6M</label>
                    </div>
                    <div class='col-1'></div>
                </div>
            </div>
            ...
            <div class='row'>
                ...
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta4 form-check-label justify-content-center" for="0402">3M</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta4 form-check-label justify-content-center" for="0403">3d</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
    ...
    <div class="row">
        <div class="col-1"></div>
        <div class="col"><img src=" {{ asset('imagen/ExamenT1214B/P1B.png') }}" alt=""
                style="height:100%; width:100%;"></div>
        <div class="col-1"></div>
    </div>
    <br>
            ...
            <div class='row'>
                <div class='col-6'>
                    <div class="form-check  col">
                        ...
                        <label class="respuesta5 form-check-label justify-content-center" for="0501">3M</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta5 form-check-input" value="B" id="0502" name="respuesta5">
                        <label class="respuesta5 form-check-label justify-content-center" for="0502">4J</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta5 form-check-input" value="C" id="0503" name="respuesta5">
                        <label class="respuesta5 form-check-label justify-content-center" for="0503">3d</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta5 form-check-input" value="D" id="0504" name="respuesta5">
                        <label class="respuesta5 form-check-label justify-content-center" for="0504">3A</label>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class='col-6'>
                    <div class="form-check col">
                        ...
                        <label class="respuesta6 form-check-label justify-content-center" for="0601">7d</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta6 form-check-input" value="B" id="0602" name="respuesta6">
                        <label class="respuesta6 form-check-label justify-content-center" for="0602">8J</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta6 form-check-input" value="C" id="0603" name="respuesta6">
                        <label class="respuesta6 form-check-label justify-content-center" for="0603">7m</label>
                    </div>
                </div>
                <div class='col-6'>
                    <div class="form-check col">
                        <input type="radio" class="respuesta6 form-check-input" value="D" id="0604" name="respuesta6">
                        <label class="respuesta6 form-check-label justify-content-center" for="0604">7M</label>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class='row'>
                <div class='col-6'>
                    ...
                    <div class="form-check  col">
                        ...
                        <label class="respuesta7 form-check-label justify-content-center" for="0701">6d</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                ...
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta7 form-check-label justify-content-center" for="0703">6A</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta7 form-check-label justify-content-center" for="0704">6M</label>
                    </div>
                    <div class='col-1'></div>
                </div>
            </div>
            ...
            <div class='row'>
                <div class='col-6'>
                    ...
                    <div class="form-check  col">
                        ...
                        <label class="respuesta8 form-check-label justify-content-center" for="0801">2M</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta4 form-check-label justify-content-center" for="0802">2m</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta8 form-check-label justify-content-center" for="0803">2d</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta8 form-check-label justify-content-center" for="0804">2A</label>
                    </div>
                    <div class='col-1'></div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-1"></div>
        <div class="col"><img src=" {{ asset('imagen/ExamenT1214B/P2A.png') }}" alt=""
                style="height:100%; width:100%;"></div>
        <div class="col-1"></div>
    </div>
    <div class="row form-group">
            ...
            <div class='row'>
                ...
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta9 form-check-label justify-content-center" for="0902">Mi menor antigua o natural</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta9 form-check-label justify-content-center" for="0903">Mi menor armónica</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="respuesta9 form-check-label justify-content-center" for="0904">Mi menor melódica ascendente</label>
                    </div>
                    <div class='col-1'></div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-1"></div>
        <div class="col"><img src=" {{ asset('imagen/ExamenT1214B/P2B.png') }}" alt=""
                style="height:100%; width:100%;"></div>
        <div class="col-1"></div>
    </div>
    <div class="row form-group">
                ...
                <div class='col-6'>
                    ...
                    <div class="form-check  col">
                        <input type="radio" class="respuesta11 form-check-input" value="A" id="1101"
                            name="respuesta11">
                        <label class="respuesta11 form-check-label justify-content-center" for="1101">Fa# mayor</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta11 form-check-input" value="B" id="1102"
                            name="respuesta11">
                        <label class="respuesta11 form-check-label justify-content-center" for="1102">Fa# menor antigua o natural</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta11 form-check-input" value="C" id="1103"
                            name="respuesta11">
                        <label class="respuesta11 form-check-label justify-content-center" for="1103">Fa# menor armónica</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta11 form-check-input" value="D" id="1104"
                            name="respuesta11">
                        <label class="respuesta11 form-check-label justify-content-center" for="1104">Fa# menor melódica ascendente</label>
                    </div>
                    <div class='col-1'></div>
                </div>
            </div>
                ...
                <div class='col-6'>
                    ...
                    <div class="form-check  col">
                        <input type="radio" class="respuesta12 form-check-input" value="A" id="1201"
                            name="respuesta12">
                        <label class="respuesta12 form-check-label justify-content-center" for="1201">Sib mayor</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta12 form-check-input" value="B" id="1202"
                            name="respuesta12">
                        <label class="respuesta12 form-check-label justify-content-center" for="1202">Sib menor antigua o natural</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta12 form-check-input" value="C" id="1203"
                            name="respuesta12">
                        <label class="respuesta12 form-check-label justify-content-center" for="1203">Sib menor armónica</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='col-6'>
                    ...
                    <div class="form-check col">
                        <input type="radio" class="respuesta12 form-check-input" value="D" id="1204"
                            name="respuesta12">
                        <label class="respuesta12 form-check-label justify-content-center" for="1204">Sib menor melódica ascendente</label>
                    </div>
                    <div class='col-1'></div>
                </div>
            </div>
    ...
    <label class="respuesta13 form-check-label justify-content-center" for="1303"> <img
            src=" {{ asset('imagen/ExamenT1214B/P3A.png') }}" alt="" style="height:100%; width:100%;"></label>
        ...
        <div class='container'>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta13 form-check-label justify-content-center" for="1301"> <img
                            src=" {{ asset('imagen/ExamenT1214B/P3AA.png') }}" alt=""
            ...
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta13 form-check-label justify-content-center" for="1302"> <img
                            src=" {{ asset('imagen/ExamenT1214B/P3AB.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta13 form-check-label justify-content-center" for="1303"> <img
                            src=" {{ asset('imagen/ExamenT1214B/P3AC.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta13 form-check-label justify-content-center" for="1304"> <img
                            src=" {{ asset('imagen/ExamenT1214B/P3AD.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
    ...
    <label class="respuesta14 form-check-label justify-content-center" for="1401"> <img
            src=" {{ asset('imagen/ExamenT1214B/P3B.png') }}" alt="" style="height:100%; width:100%;"></label>
        ...
        <div class='container'>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta14 form-check-label justify-content-center" for="1401"> <img
                            src=" {{ asset('imagen/ExamenT1214B/P3BA.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta14 form-check-label justify-content-center" for="1402"> <img
                            src=" {{ asset('imagen/ExamenT1214B/P3BB.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta14 form-check-label justify-content-center" for="1403"> <img
                            src=" {{ asset('imagen/ExamenT1214B/P3BC.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
            <div class='row'>
                ...
                <div class="form-check col">
                    ...
                    <label class="respuesta14 form-check-label justify-content-center" for="1404"> <img
                            src=" {{ asset('imagen/ExamenT1214B/P3BD.png') }}" alt=""
                            style="height:100%; width:100%;"></label>
                </div>
                <div class='col-1'></div>
            </div>
    ...
    <label class="respuesta15 form-check-label justify-content-center" for="1501"> <img
            src=" {{ asset('imagen/ExamenT1214B/P4A.png') }}" alt="" style="height:100%; width:100%;"></label>
    ...
    <label class="respuesta18 form-check-label justify-content-center" for="1801"> <img
            src=" {{ asset('imagen/ExamenT1214B/P4B.png') }}" alt="" style="height:100%; width:100%;"></label>
