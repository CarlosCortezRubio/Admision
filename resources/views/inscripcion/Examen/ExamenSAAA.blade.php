    ...
    <form action="{{ route('evaluar', ['id_postulante' => $id_postulante,'cod_examen' => session('examen')]) }}" id="formevaluar" method="post">
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-1"></div>
                <div class="col"><img src="{{ asset('imagen/ExamenSAAA/P1.png') }}" alt="" style="height:100%; width:100%;"></div>
                <div class="col-1"></div>
            </div>
            <div class='container'>
                <div class='row'>
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-1"></div>
                <div class="col"><img src="{{ asset('imagen/ExamenSAAA/P2.png') }}" alt="" style="height:100%; width:100%;"></div>
                <div class="col-1"></div>
            </div>
            <div class='container'>
                <div class='row'>
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-1"></div>
                <div class="col"><img src="{{ asset('imagen/ExamenSAAA/P3.png') }}" alt="" style="height:100%; width:100%;"></div>
                <div class="col-1"></div>
            </div>
            <div class='container'>
                <div class='row'>
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-1"></div>
                <div class="col"><img src="{{ asset('imagen/ExamenSAAA/P4.png') }}" alt="" style="height:100%; width:100%;"></div>
                <div class="col-1"></div>
            </div>
            <div class='container'>
                <div class='row'>
                ...
                <div class='row'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="form-check-label " for="0402">b) Retardo y cambiata</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='row'>
                ...
                <div class='row'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="form-check-label" for="0404">d) Retardo y bordadura</label>
                    </div>
                    <div class='col-1'></div>
                </div>
                <div class='row'>
                    ...
                    <div class="form-check col">
                        ...
                        <label class="form-check-label" for="0405">e) Anticipación y apoyatura</label>
                    </div>
                    <div class='col-1'></div>
                </div>
            </div>
