...
*/
define ( 'NOM_PROYECTO', "Encuestas - Reportes" );					// Nombre de la aplicación (se muestra en la pestaña del navegador)
...
define ( 'NOMSIST', 'repencuesta' );				// Nombre de la carpeta que contiene la aplicación
