<?php /* Smarty version 2.6.30, created on 2021-06-09 05:17:01
         compiled from C:%5Cxampp%5Chtdocs%5Cencuestaunm/app/vista/Encuesta/Encuesta.tpl */ ?>
<?php echo '
...
//         valor = document.getElementById("campo").value;
	...
	function buscarRegistro(op,valor1,valor2){
		//alert(\'op = \'+op)
				...
				jQuery.ajax({
					url: "http://localhost/encuestaunm/app/cont/encuesta/consultar.php",        // Url to which the request is send
