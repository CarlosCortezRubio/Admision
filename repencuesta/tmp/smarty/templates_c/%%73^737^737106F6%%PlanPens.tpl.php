<?php /* Smarty version 2.6.30, created on 2021-04-07 04:59:13
         compiled from C:%5Cxampp%5Chtdocs%5CnominaGob/app/vista/PlanPens/PlanPens.tpl */ ?>
<?php echo '
...
<div class="form-group col-lg-4">
	...
	<div class="">
		<input id='total_imponiblePlanPens' name='total_imponiblePlanPens' value='<?php echo $this->_tpl_vars['total_imponiblePlanPens']; ?>
' maxlength='64' class='form-control input-sm' />
	</div>
</div>
<div class="form-group col-lg-4">
	...
	<div class="">
		<input id='total_haberPlanPens' name='total_haberPlanPens' value='<?php echo $this->_tpl_vars['total_haberPlanPens']; ?>
' maxlength='64' class='form-control input-sm' />
	</div>
</div>
<div class="form-group col-lg-4">
	...
	<div class="">
		<input id='total_descuentosPlanPens' name='total_descuentosPlanPens' value='<?php echo $this->_tpl_vars['total_descuentosPlanPens']; ?>
' maxlength='64' class='form-control input-sm' />
	</div>
</div>
<div class="form-group col-lg-4">
	...
	<div class="">
		<input id='total_liquidoPlanPens' name='total_liquidoPlanPens' value='<?php echo $this->_tpl_vars['total_liquidoPlanPens']; ?>
' maxlength='64' class='form-control input-sm' />
	</div>
</div>
<div class="form-group col-lg-4">
