...
<div class='line-title-con'>
	...
	<form name='form' id='form' method='post' action='{$valorForm}'>
		<div class='line-title'>
			<h4>{if $opt == 'g'} Agregar {elseif $opt == 'm' || $opt == 'mr'} Modificar {/if} Región cargo</h4>
		</div>
		<a id='ancla' href='#'></a>
...
<div class="form-group col-lg-4">
	...
	<br />
		...
		<input type='hidden' id='idRegionCargo' name='idRegionCargo' value='{$idRegionCargo}' readonly/>
