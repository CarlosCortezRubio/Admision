...
function clickVerPdf($valor,$tipo,$anio,$mes)
{    
    global $objResponse;
    $objResponse = new xajaxResponse();
    ...
    if ( $tabla != null){
        $objResponse->call("verpdf('$valor',1,'$anio','$mes')");
    }else{
        //$objResponse->call("ventanaAlerta('No hay datos para este periodo','Ver Periodo')");
