 ...
 *  
 * Imprimir de la Tabla NivelOrigen 
 * 
 * @author UNM 
 * @version V 0.1 
 * @date 28/07/2021
...
$aux = $opt; 
		...
		$tabla = $objNivelOrigen->consultarNivelOrigenXidNivelOrigen($aux);
		$objNivelOrigen->cerrarConexion();
		if ($tabla > 0) {
			$etiquetas = array('id', 'cod', 'nom');
			$campos = array('idNivelOrigen', 'codNivelOrigen', 'nomNivelOrigen');
