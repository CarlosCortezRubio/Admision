...
//     $tablaDatos = $tablaDatos[0];
    ...
    foreach ($tablaDatos as $tabla) {
        ...
        $dniPlanillaPensionado = $tabla['dniPersona'];
        ...
        $tipo_de_regimenPlanillaPensionado = $tabla['tipoRegimenPesona'];
        ...
        $ruc = $tabla['dniPersona'];
        $razonSocial = $tabla['dniPersona'];
        $periodo = $tabla['dniPersona'];
        ...
        $datosReporte = datosReporte($dniPlanillaPensionado, $apellidos_y_nombresPlanillaPensionado, $fecha_de_nacimientoPlanillaPensionado, $sexoPlanillaPensionado, $planillaPlanillaPensionado, $tipo_de_regimenPlanillaPensionado, $resolucion_de_pension_definitivaPlanillaPensionado, $a_partir_dePlanillaPensionado, $ruc,$razonSocial,$periodo);
//         if (count($tablaConceptos) > 0) {
