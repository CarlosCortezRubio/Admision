    ...
    function reporte1Excel($request, $session)
    {
        ...
        {    
            ...
            for ($k = 0; $k < count($tabla); $k ++) {
               ...
               // var_dump(count(array_keys($tabla[$k])));
           
              
                    //$row = (isset($tabla[$k])) ? array_keys($tabla[$k]) : '';   
            ...
            //echo $anio." ". $mes. " no  hay data en este periodo ***************<br>";

            $mns = "Actualmente no se puede presentar el reporte, por favor intentelo nuevamente";
            //     $mns = 'test';
            //echo $html= $mns;

            echo "<script> alert('Actualmente no se puede presentar el reporte, por favor intentelo nuevamente');
                 </script>";
