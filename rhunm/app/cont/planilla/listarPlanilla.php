...
class principalPlanilla extends Controller
{
    ...
    function principalPlanilla()
    {
        ...
        $this->campos = 'idplanillaPensionado,idEmpleado,idPeriodo,idTipoPlanilla,fecplanillaPensionado,totImpplanillaPensionado,totHabplanillaPensionado,totDescplanillaPensionado,totLiqplanillaPensionado,diasTrabajados,permisos,huelgas,inasistencias,licDias,fechaInitLic';
