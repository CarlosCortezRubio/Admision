...
//             $resultado = $objPlanillaPensionado->consultarPlanillaPensionadoX_ESPECIFICAR_METODO($campoBusqueda); // EDITABLE
            $resultado = $objPlanillaPensionado->consultarPlanillaPensionadoXparam($campoBusqueda,1); // EDITABLE
        } else {
            $resultado = $objPlanillaPensionado->consultarPlanPensConsolidadoXidTipoPlanilla(1); // EDITABLE
        ...
        $etiquetas = array('','Editar','Planilla','Dni','Nombre','Apellido','Periodo','Fecha Creada','Total Imp.','Total Hab.','Total Dsc.','Total Liq');
        //$etiquetas = array('','Boletas','Planillas','Editar','Año','Planilla','Tipo de regimen','Res. de pension','T imp','T haber','T desc.','T liquido');
        if ($resultado != null) {
            ...
            $campos = array('obj_' . $chk,'obj_' . $img1,'idplanillaPensionado','dniPersona','nom1Persona','ape1Persona','idPeriodo','fecplanillaPensionado',
...
function llenarGridPlanPensNom($campoBusqueda, $indice)
{
    ...
    try {
        ...
        $etiquetas = array('','Editar','Id','Empleado','Periodo','Tipo Planilla','fecPlanillaPensionado','Total Imp.','Total Hab.','Total Dsc.','Total Liq');
        if ($resultado != null) {
            $cantReg = count($resultado);
            ...
            // $campos = array('obj_' . $chk,'obj_' . $img3,'obj_' . $img4,'obj_' . $img1,
            $campos = array('obj_' . $chk,'obj_' . $img1,'idPlanillaPensionado','idEmpleado','idPeriodo','idTipoPlanilla','fecPlanillaPensionado','totImpplanillaPensionado','totHabplanillaPensionado','totDescplanillaPensionado','totLiqplanillaPensionado');
...
function clickPlanillaPensionado($id, $ind)
{
    ...
    switch ($ind) {
        case 1:
            $objResponse->script("vntConsultar('planilla/consultar/$id', 'Consultar Planilla');");
            break;
        case 2:
            ;
            break;
