 ...
 * @file nummagist.php 
 *  
 * Imprimir de la Tabla NumMagist 
 * 
 * @author UNM 
 * @version V 0.1 
 * @date 28/07/2021
...
$aux = $opt; 
		...
		$tabla = $objNumMagist->consultarNumMagistXidNumMagist($aux);
		$objNumMagist->cerrarConexion();
		if ($tabla > 0) {
			$etiquetas = array('id', 'cod', 'nom');
			$campos = array('idNumMagist', 'codNumMagist', 'nomNumMagist');
