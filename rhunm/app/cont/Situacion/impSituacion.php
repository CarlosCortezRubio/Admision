 ...
 * @file situacion.php 
 *  
 * Imprimir de la Tabla Situacion 
 * 
 * @author UNM 
 * @version V 0.1 
 * @date 28/07/2021
...
$aux = $opt; 
		...
		$tabla = $objSituacion->consultarSituacionXidSituacion($aux);
		$objSituacion->cerrarConexion();
		if ($tabla > 0) {
			$etiquetas = array('id', 'cod', 'nom');
			$campos = array('idSituacion', 'codSituacion', 'nomSituacion');
