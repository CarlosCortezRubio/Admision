...
class Planilla extends Query
{
    ...
    function compAgregarPlanillaPensionado($idEmpleado, $idPeriodo, $idTipoPlanilla, $fecplanillaPensionado, $totImpplanillaPensionado, $totHabplanillaPensionado, $totDescplanillaPensionado, $totLiqplanillaPensionado, $diasTrabajados, $permisos, $huelgas, $inasistencias, $licDias, $fechaInitLic, $matConceptos)
    {
       ...
       // die('los parametros');
        ...
        $resultado1 = $this->agregarPlanillaPensionado($idEmpleado, $idPeriodo, $idTipoPlanilla, $fecplanillaPensionado, $totImpplanillaPensionado, $totHabplanillaPensionado, $totDescplanillaPensionado, $totLiqplanillaPensionado, $diasTrabajados, $permisos, $huelgas, $inasistencias, $licDias, $fechaInitLic);
...
//         dump($matConceptos);
    ...
    function agregarPlanillaPensionado($idPersona, $idPeriodo, $idTipoPlanilla, $fecplanillaPensionado, $totImpplanillaPensionado, $totHabplanillaPensionado, $totDescplanillaPensionado, $totLiqplanillaPensionado, $diasTrabajados, $permisos, $huelgas, $inasistencias, $licDias, $fechaInitLic)
    ...
    //     $idTipoPlanilla)
    {
        ...
        $diasTrabajados= parent::prepareParam($diasTrabajados, Query::DATATYPE_INTEGER);
        $permisos= parent::prepareParam($permisos, Query::DATATYPE_INTEGER);
        $huelgas= parent::prepareParam($huelgas, Query::DATATYPE_INTEGER);
        $inasistencias= parent::prepareParam($inasistencias, Query::DATATYPE_INTEGER);
        $licDias= parent::prepareParam($licDias, Query::DATATYPE_INTEGER);
        $fechaInitLic= parent::prepareParam($fechaInitLic, Query::DATATYPE_STRING, 0);
