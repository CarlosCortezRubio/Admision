...
(?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?) ";
    ...
    const DUPLICAR_PLANILLA_PLANPENS = "INSERT INTO planpens (idPeriodo,dniPlanPens, apellidos_y_nombresPlanPens, fecha_de_nacimientoPlanPens, sexoPlanPens, 
codigo_modularPlanPens, planillaPlanPens, tipo_de_regimenPlanPens, resolucion_de_pension_definitivaPlanPens, a_partir_dePlanPens, 
bancoPlanPens, cuenta_bancariaPlanPens, fuente_de_financiamientoPlanPens, planilla2PlanPens, total_imponiblePlanPens, 
total_haberPlanPens, total_descuentosPlanPens, total_liquidoPlanPens, aguinaldoPlanPens, basicaPlanPens, 
bonif_personalPlanPens, ael25671PlanPens, aeds081PlanPens, tphPlanPens, bonif_familiarPlanPens, 
...
FROM planpens where idPeriodo = ?";
    ...
    const DUPLICAR_PLANILLA_PLANPENS_CON = "INSERT INTO PlanPensCon (idPeriodo,dniPlanPens, apellidos_y_nombresPlanPens, fecha_de_nacimientoPlanPens, sexoPlanPens, 
codigo_modularPlanPens, planillaPlanPens, tipo_de_regimenPlanPens, resolucion_de_pension_definitivaPlanPens, a_partir_dePlanPens, 
bancoPlanPens, cuenta_bancariaPlanPens, fuente_de_financiamientoPlanPens, planilla2PlanPens, total_imponiblePlanPens, 
total_haberPlanPens, total_descuentosPlanPens, total_liquidoPlanPens, aguinaldoPlanPens, basicaPlanPens, 
bonif_personalPlanPens, ael25671PlanPens, aeds081PlanPens, tphPlanPens, bonif_familiarPlanPens, 
...
ipssPlanPens, cafaePlanPens, prderrmaPlanPens, escolaridadPlanPens, decreto_supermo_20_21PlanPens, 
?, ?, preG,p_del20530PlanPens
FROM PlanPensCon where idPeriodo = ?";
    
    const DUPLICAR_PLANILLA_PLANPENS_ORF = "INSERT INTO PlanPensOrf (idPeriodo,dniPlanPens, apellidos_y_nombresPlanPens, fecha_de_nacimientoPlanPens, sexoPlanPens,
codigo_modularPlanPens, planillaPlanPens, tipo_de_regimenPlanPens, resolucion_de_pension_definitivaPlanPens, a_partir_dePlanPens,
bancoPlanPens, cuenta_bancariaPlanPens, fuente_de_financiamientoPlanPens, planilla2PlanPens, total_imponiblePlanPens,
total_haberPlanPens, total_descuentosPlanPens, total_liquidoPlanPens, aguinaldoPlanPens, basicaPlanPens,
bonif_personalPlanPens, ael25671PlanPens, aeds081PlanPens, tphPlanPens, bonif_familiarPlanPens,
...
ipssPlanPens, cafaePlanPens, prderrmaPlanPens, escolaridadPlanPens, decreto_supermo_20_21PlanPens,
?, ?, preG,p_del20530PlanPens
FROM PlanPensOrf where idPeriodo = ?";
    const ELIMINAR_PLANPENS = "DELETE FROM PlanPens WHERE idPlanPens = ?";
    
    const ACTUALIZAR_EDO_PLANPENS = "UPDATE PlanPens SET edoPlanPens = ? WHERE idPlanPens = ?";

//     const CONSULTAR_PLANPENS = "SELECT * FROM PlanPens WHERE edoPlanPens = 1 ORDER BY idPlanPens";
    const CONSULTAR_PLANPENS_DEF = "SELECT @rownum:=@rownum+1 nro, anio,mes,dniPlanPens,apellidos_y_nombresPlanPens,planillaPlanPens,tipo_de_regimenPlanPens,resolucion_de_pension_definitivaPlanPens,total_imponiblePlanPens,total_haberPlanPens,total_descuentosPlanPens,total_liquidoPlanPens FROM PlanPens t, (SELECT @rownum:=0) r WHERE edoPlanPens = 1 ORDER BY idPlanPens";
    const CONSULTAR_PLANPENS_DEF_POR_ANIO_Y_MES = "SELECT @rownum:=@rownum+1 nro, anio,mes,dniPlanPens,apellidos_y_nombresPlanPens,planillaPlanPens,tipo_de_regimenPlanPens,resolucion_de_pension_definitivaPlanPens,total_imponiblePlanPens,total_haberPlanPens,total_descuentosPlanPens,total_liquidoPlanPens FROM PlanPens t, (SELECT @rownum:=0) r WHERE edoPlanPens = 1 and anio = ? AND mes = ? ORDER BY idPlanPens";
    
    
    const CONSULTAR_PLANPENS = "SELECT @rownum:=@rownum+1 nro, t.* FROM PlanPens t, (SELECT @rownum:=0) r WHERE edoPlanPens = 1 ORDER BY idPlanPens";
    const CONSULTAR_PLANPENS_POR_ANIO_Y_MES = "SELECT @rownum:=@rownum+1 nro, t.* FROM PlanPens t, (SELECT @rownum:=0) r WHERE anio = ? AND mes = ? AND edoPlanPens = 1 ORDER BY idPlanPens";
    
    const CONSULTAR_PLANPENS_TOTALES = "SELECT sum(total_imponiblePlanPens) AS totales_imponiblePlanPens,sum(total_haberPlanPens) AS totales_haberPlanPens,sum(total_descuentosPlanPens) AS totales_descuentosPlanPens,sum(total_liquidoPlanPens) AS totales_liquidoPlanPens FROM PlanPens t, (SELECT @rownum:=0) r WHERE edoPlanPens = 1 ORDER BY idPlanPens";
    const CONSULTAR_PLANPENS_TOTALES_POR_ANIO_Y_MES = "SELECT sum(total_imponiblePlanPens) AS totales_imponiblePlanPens,sum(total_haberPlanPens) AS totales_haberPlanPens,sum(total_descuentosPlanPens) AS totales_descuentosPlanPens,sum(total_liquidoPlanPens) AS totales_liquidoPlanPens FROM PlanPens t, (SELECT @rownum:=0) r WHERE edoPlanPens = 1 AND anio = ? AND mes = ? ORDER BY idPlanPens";

    const CONSULTAR_PLANPENS_POR_IDPLANPENS = "SELECT * FROM PlanPens WHERE idPlanPens = ?";
    
    const CONSULTAR_PLANPENS_ESTADO_POR_IDPLANPENS = "SELECT * FROM PlanPens INNER JOIN Periodo USING(idPeriodo) WHERE idPlanPens = ?";
...
WHERE anio = ? AND mes = ?";
    ...
    const CONSULTAR_PLANPENS_POR_DNI_POR_PARAMS = "SELECT * FROM PlanPens WHERE mes = ? AND anio = ? AND UPPER(dniPlanPens) = UPPER(?) AND edoPlanPens = 1";
    ...
    const CONSULTAR_PLANPENS_POR_APELLIDOS_Y_NOMBRES_APROX = "SELECT * FROM PlanPens WHERE UPPER(apellidos_y_nombresPlanPens) LIKE UPPER(?) AND edoPlanPens = 1 ORDER BY apellidos_y_nombresPlanPens";
