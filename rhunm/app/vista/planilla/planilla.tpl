...
<div class='pagina container'>
	<form name='form' id='form' method='post' action='{$valorForm}'>
		<div class='line-title'>
			<h4>{if $opt == 'g'} Agregar {elseif $opt == 'm' || $opt == 'mr'} Modificar {/if} Planilla</h4>
			{* <div class="form-group col-lg-12" style="position:fixed;z-index: 2000;top: 188px;left: 250px;">
				...
				<ul class="nav nav-tabs">
				  ...
				  <li class="nav-item">
					<a class="nav-link" data-toggle="tab" href="#menu4" onclick="totalizar();">VARIACIONES</a>
				  </li>				 
				</ul>
			</div> *}
						  	...
						  	<div class="row">
								...
								<div class="form-group col-lg-2">
									...
									<div class=""> 
										...
										<input id='codModularPersona' name='codModularPersona' value='{$docPersona}-{$idEmpleado}' maxlength='64' class='form-control input-sm' readonly />
									</div>
								</div>
								<div class="form-group col-lg-5">
						...
						<div class="tab-pane fade" id="menu4" role="tabpanel" aria-labelledby="menu4-tab">
							<div class="row">
								<div class="form-group col-lg-3">
									...
									<div class="">
										<div class="input-group input-group-sm">
										<input id='diaTrabajados' name='diaTrabajados' class='form-control input-sm' type='text' value='{$diaTrabajados}' maxlength='10' disabled>
										</div>
									</div>
								</div>
								<div class="form-group col-lg-3">
									...
									<div class="">
										<div class="input-group input-group-sm">
											<input id='permisos' name='permisos' class='form-control input-sm' type='text' value='{$permisos}' maxlength='10' disabled>
										</div>
									</div>
								</div>
								<div class="form-group col-lg-3">
									...
									<div class="">
										<div class="input-group input-group-sm">
								<input id='huelgas' name='huelgas' class='form-control input-sm' type='text' value='{$huelgas}' maxlength='10' disabled>
								</div>
									</div>
								</div>
								<div class="form-group col-lg-3">
									...
									<div class="">
										<div class="input-group input-group-sm">
											<input id='inasistencias' name='inasistencias' class='form-control input-sm' type='text' value='{$inasistencias}' maxlength='10' disabled>
										</div>
									</div>	
								</div>
								<div class="form-group col-lg-3">
									...
									<div class="">
										<div class="input-group input-group-sm">
											<input id='licencia' name='licencia' class='form-control input-sm' type='text' value='{$licencia}' maxlength='10' disabled>
										</div>
									</div>	
								</div>
								...
								<div id='fechLicencia' class="form-group col-lg-3" style="visibility:hidden">
									...
									<div class="">
										<div class="input-group input-group-sm">
											<input id='fechLic' name='fechLic' class='form-control input-sm' type='text' value='{$fechLic}' maxlength='10' disabled>
										</div>
									</div>
							</div>
	...
	<br />
		...
		<input type='hidden' id='idEmpleado' name='idEmpleado' value='{$idEmpleado}' maxlength='64' class='form-control input-sm' readonly/>
