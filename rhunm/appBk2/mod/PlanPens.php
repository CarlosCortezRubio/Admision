...
class PlanPens extends Query
{
    ...
    function agregarPlanPens($idPlanPens, $dniPlanPens, $apellidos_y_nombresPlanPens, $fecha_de_nacimientoPlanPens, $sexoPlanPens, $codigo_modularPlanPens, $planillaPlanPens, 
    ...
    function duplicarPlanilla($idTipoPlanilla,$origen,$destino,$anioDestino,$mesDestino){
        //         echo "en duplicarPlanilla con ($idTipoPlanilla,$origen,$destino,$anioDestino,$mesDestino)";die();
        $params = array(
        ...
        switch ($idTipoPlanilla) {
            case 1:
                $planilla = 'PlanPens';
                return parent::execute(SQLPlanPens::DUPLICAR_PLANILLA, $params);
            break;
            case 2:
                $planilla = 'PlanPensCon';
                return parent::execute(SQLPlanPens::DUPLICAR_PLANILLA_PLANPENS_CON, $params);
            break;
            case 3:
                $planilla = 'PlanPensOrf';
                return parent::execute(SQLPlanPens::DUPLICAR_PLANILLA_PLANPENS_ORF, $params);
            break;
        }
//         $params = array(
...
//         return parent::execute(SQLPlanPens::DUPLICAR_PLANILLA, $params);
    ...
    {
        return parent::executeQuery(SQLPlanPens::CONSULTAR_PLANPENS_DEF);
    }
    function consultarPlanPensDefXanioYmes($anio,$mes)
    {
        $params = array(
            $anio,$mes
        );
        return parent::executeQuery(SQLPlanPens::CONSULTAR_PLANPENS_DEF_POR_ANIO_Y_MES,$params);
    }
    function consultarPlanPensTotales()
    {
        return parent::executeQuery(SQLPlanPens::CONSULTAR_PLANPENS_TOTALES);
    }
    function consultarPlanPensTotalesXanioYmes($anio,$mes)
    {
        ...
        return parent::executeQuery(SQLPlanPens::CONSULTAR_PLANPENS_TOTALES_POR_ANIO_Y_MES,$params);
    }
    ...
    function consultarPlanPensEdoXidPlanPens($idPlanPens)
    {
        $params = array(
            $idPlanPens
        );
        return parent::executeQuery(SQLPlanPens::CONSULTAR_PLANPENS_ESTADO_POR_IDPLANPENS, $params);
    }
    function consultarPlanPensConsolidadoXmes($anio,$mes)
    {
        ...
        return parent::executeQuery(SQLPlanPens::CONSULTAR_PLANPENS_CONSOLIDADO_POR_MES, $params);
    }
    function consultarPlanPensXanioYmes($anio,$mes)
    {
        ...
        return parent::executeQuery(SQLPlanPens::CONSULTAR_PLANPENS_POR_ANIO_Y_MES, $params);
    }
    ...
    function consultarPlanPensXparam($campBusq)
    {
//         echo "[$campBusq]";
...
//         dump($matCampBusq);die();
        if ($matCampBusq[0]==1) {
            ...
            return parent::executeQuery(SQLPlanPens::CONSULTAR_PLANPENS_POR_DNI_POR_PARAMS, $params);
        }else{
            $params = array(
                $matCampBusq[1],
                $matCampBusq[2],
            ...
            return parent::executeQuery(SQLPlanPens::CONSULTAR_PLANPENS_POR_NOM_POR_PARAMS, $params);
        }
//         return parent::executeQuery(SQLPlanPens::CONSULTAR_PLANPENS_POR_DNI, $params);
    }
    ...
    function actEdoPlanPensDesact($edoPlanPens,$id_PlanPens)
    {
        ...
        return parent::execute(SQLPlanPens::ACTUALIZAR_EDO_PLANPENS, $params);
    }
