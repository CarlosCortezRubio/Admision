...
<div style="margin-top: 5px;" id='cancelar' onclick="cerrarvntPequena();" type="button" class="btn btn-default glyphicon glyphicon-circle-arrow-left btn-verde"></div>
	...
	<form name='form' id='form' method='post' action='{$valorForm}'>
		<div class='line-title'>
			<h4>{if $opt == 'g'} Agregar {elseif $opt == 'm' || $opt == 'mr'} Modificar {/if} Dir. Encargo</h4>
		</div>
		<a id='ancla' href='#'></a>
...
<div class="form-group col-lg-4">
	<label class="control-label">Código Dir. Encargo</label>
	<div class="">
		{$codDirEncargo}
	</div>
</div>
<div class="form-group col-lg-4">
	<label class="control-label">Nombre Dir. Encargo</label>
	<div class="">
		{$nomDirEncargo}
	</div>
</div>
