					...
					<div class="form-group col-lg-12">
						<fieldset>	
								<div class="form-group col-md-4 divIconosCent">
									<label target="_blank">
										<img onCLick="enviar('ArchivoSal/reporte1')" src="{$PUB_URLSIST}img/home/pdf.jpg" class="iconoDesktop" style="max-width:50px;">
										<label class="control-label">Archivo 1</label>
									</label>
								</div>
								<div class="form-group col-md-4 divIconosCent">
