...
<div class='pagina'>
	<form name='form' id='form' method='post' action='{$valorForm}'>
		<div class='line-title'>
			<h4>{if $opt == 'g'} Agregar {elseif $opt == 'm' || $opt == 'mr'} Modificar {/if} Orfandad</h4>		
					  	...
					  	<div class="tab-pane container active row" id="home">
						  	<div class="row">
								<div class="form-group col-lg-3">
									...
									<div class="">
										<select id='anio' name='anio' class='form-control input-sm' readonly>
								...
								<div class="form-group col-lg-2">
									...
									<div class="">
										<select id='mes' name='mes' class='form-control input-sm' readonly>
											<option value=''>-Seleccione-</option>
								...
								<div class="form-group col-lg-2">
									...
									<div class="">
										<select id='sexoPlanPens' name='sexoPlanPens' class='form-control input-sm'>
											<option value=''>-Seleccione-</option>
											{html_options options=$tablaGenero selected=$sexoPlanPens}
										</select>
									</div>
								</div>
								<!--
								...
								<div class="form-group col-lg-3">
									...
									<div class="">
										<select id='bancoPlanPens' name='bancoPlanPens' class='form-control input-sm'>
											<option value=''>-Seleccione-</option>
											{html_options options=$tablaBanco selected=$bancoPlanPens}
										</select>									
					  ...
					  <div class="tab-pane container fade" id="menu1">
						  <div class="row">
							...
							<div class="form-group col-lg-2">
								...
								<div class="">
									<input id='p_del20530PlanPens' name='p_del20530PlanPens' value='{$p_del20530PlanPens}' maxlength='64' class='form-control input-sm valIngreso' />
								</div>
							</div>
						  </div>
					  </div>
