...
<div id='paginacion1'></div>
        ...
        <script>
                ...
                gridEmpleado.setInitWidths('25|60|60|60|60|99|101|130|*|104|150|');
                gridEmpleado.setColAlign('center|center|center|center|right|right|right|right|right|right|center|right');//            
