 ...
 *  
 * Imprimir de la Tabla RegionCargo 
 * 
 * @author UNM 
 * @version V 0.1 
 * @date 28/07/2021
...
$aux = $opt; 
		...
		$tabla = $objRegionCargo->consultarRegionCargoXidRegionCargo($aux);
		$objRegionCargo->cerrarConexion();
		if ($tabla > 0) {
			$etiquetas = array('id', 'cod', 'nom');
			$campos = array('idRegionCargo', 'codRegionCargo', 'nomRegionCargo');
