 ...
 *  
 * Imprimir de la Tabla TipServidor 
 * 
 * @author UNM 
 * @version V 0.1 
 * @date 28/07/2021
...
$aux = $opt; 
		...
		$tabla = $objTipServidor->consultarTipServidorXidTipServidor($aux);
		$objTipServidor->cerrarConexion();
		if ($tabla > 0) {
			$etiquetas = array('id', 'cod', 'nom');
			$campos = array('idTipServidor', 'codTipServidor', 'nomTipServidor');
