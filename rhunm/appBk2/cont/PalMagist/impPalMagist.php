 ...
 * @file palmagist.php 
 *  
 * Imprimir de la Tabla PalMagist 
 * 
 * @author UNM 
 * @version V 0.1 
 * @date 28/07/2021
...
$aux = $opt; 
		...
		$tabla = $objPalMagist->consultarPalMagistXidPalMagist($aux);
		$objPalMagist->cerrarConexion();
		if ($tabla > 0) {
			$etiquetas = array('id', 'cod', 'nom');
			$campos = array('idPalMagist', 'codPalMagist', 'nomPalMagist');
