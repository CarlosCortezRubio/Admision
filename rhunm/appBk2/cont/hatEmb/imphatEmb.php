...
$aux = $opt; 
		...
		$tabla = $objHatEmb->consultarHatEmbXidHatEmb($aux);
		$objHatEmb->cerrarConexion();
		if ($tabla > 0) {
			$etiquetas = array('idhatEmb', 'codhatEmb', 'nomhatEmb');
			$campos = array('idhatEmb', 'codhatEmb', 'nomhatEmb');
