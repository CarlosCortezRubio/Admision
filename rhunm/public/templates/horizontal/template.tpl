...
<!-- SweetAlert 2-->
<script type="text/javascript" src="{$PATH_JS_SIST}/SweetAlert/dist/sweetalert2.all.min.js"></script>
...
<!--				{include file="../../../app/comun/menuusugeneral.tpl"}-->
				<!-- {include file="../../../app/comun/$MENU_USU.tpl"} -->
				{if $actMenNom == true}
					{include file="../../../app/comun/menunomina.tpl"}
				{/if}
			{/if}
		</div>	
	</div>
