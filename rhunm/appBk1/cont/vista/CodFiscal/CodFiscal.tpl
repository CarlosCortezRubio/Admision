...
<div class='pagina'>
	<form name='form' id='form' method='post' action='{$valorForm}'>
		<div class='line-title'>
			<h4>{if $opt == 'g'} Agregar {elseif $opt == 'm' || $opt == 'mr'} Modificar {/if} Codigo Fiscal</h4>
		</div>
		<a id='ancla' href='#'></a>
...
<div class="form-group col-lg-4">
	...
	<div class="">
		<input id='codCodFiscal' name='codCodFiscal' value='{$codCodFiscal}' maxlength='8' class='form-control input-sm' />
	</div>
</div>
<div class="form-group col-lg-4">
	<label class="control-label">Nombre Código Fiscal Fiscal</label>
	<div class="">
		<input id='nomCodFiscal' name='nomCodFiscal' value='{$nomCodFiscal}' maxlength='128' class='form-control input-sm' />
	</div>
</div>
		</div>
</div>
