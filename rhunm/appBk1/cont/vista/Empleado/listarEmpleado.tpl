...
<div id='paginacion1'></div>
        ...
        <script>
                ...
                gridEmpleado.setInitWidths('25|60|60|60|60|99|101|103|100|104|101|');
                gridEmpleado.setColAlign('center|center|center|center|right|right|right|right|right|right|right|right|right|right|right|right|right|right|right|right|right|right|right|right|right|right|left|left|left|left|left|left|left|left|right|right|left|left|left|left|left|left|left|left|right|right|right|right|right|right|right|left');
//              gridEmpleado.attachEvent('onRowDblClicked',eliminarCondicion);
                //gridEmpleado.setColTypes('ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro');
                gridEmpleado.setColTypes('ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro|ro');
                gridEmpleado.setColSorting('str|str|str|str|int|int|int|int|int|int|int|int|int|int|str|str|str|str|str|str|str|str|int|int|str|str|str|str|str|str|str|str|int|int|int|int|int|int|int|str|str|int|str|str|str|str');
