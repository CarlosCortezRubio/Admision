...
// private $grupoEdoRegistro;
	function principalEdoRegistro(){
		parent::__construct ();		
		$this->campos = 'idEdoRegistro,nomEdoRegistro,descEdoRegistro,grupoEdoRegistro';
	...
	function guardar($request,$session){
		...
		$tablaResultado = $objEdoRegistro->agregarEdoRegistro($this->idEdoRegistro,$this->nomEdoRegistro,$this->descEdoRegistro,$this->grupoEdoRegistro);
	...
	function actualizar($request,$session){
		$this->inicializarAtributos($request,$this->campos);
		$objEdoRegistro = new EdoRegistro ();
		$tablaResultado = $objEdoRegistro->actualizarEdoRegistro($this->idEdoRegistro,$this->nomEdoRegistro,$this->descEdoRegistro,$this->grupoEdoRegistro,$this->idEdoRegistro);
		$objEdoRegistro->cerrarConexion();
		if ($tablaResultado > 0) {
