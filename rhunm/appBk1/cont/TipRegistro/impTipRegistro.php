 ...
 *  
 * Imprimir de la Tabla TipRegistro 
 * 
 * @author UNM 
 * @version V 0.1 
 * @date 28/07/2021
...
$aux = $opt; 
		...
		$tabla = $objTipRegistro->consultarTipRegistroXidTipRegistro($aux);
		$objTipRegistro->cerrarConexion();
		if ($tabla > 0) {
			$etiquetas = array('id', 'nom');
			$campos = array('idTipRegistro', 'nomTipRegistro');
