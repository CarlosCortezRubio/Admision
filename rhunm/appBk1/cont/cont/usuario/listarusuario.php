...
// private $respPregSecreta;
	function principalUsuario(){
		parent::__construct ();		
		$this->campos = 'idUsuario,idPersona,idRol,idEdoRegistro,cuentaUsuario,contrasenaUsuario,fecCreacion,pregSecreta,respPregSecreta';
		$this->modelo = 'Usuario';
		$this->modulo = 'Usuario';
	...
	function guardar($request,$session){
		...
		$tablaResultado = $objUsuario->agregarUsuario($this->idUsuario,$this->idPersona,$this->idRol,$this->idEdoRegistro,$this->cuentaUsuario,$this->contrasenaUsuario,$this->fecCreacion,$this->pregSecreta,$this->respPregSecreta);
	...
	function actualizar($request,$session){
		$this->inicializarAtributos($request,$this->campos);
		$objUsuario = new Usuario ();
		$tablaResultado = $objUsuario->actualizarUsuario($this->idUsuario,$this->idPersona,$this->idRol,$this->idEdoRegistro,$this->cuentaUsuario,$this->contrasenaUsuario,$this->fecCreacion,$this->pregSecreta,$this->respPregSecreta,$this->idUsuario);
		$objUsuario->cerrarConexion();
		if ($tablaResultado > 0) {
