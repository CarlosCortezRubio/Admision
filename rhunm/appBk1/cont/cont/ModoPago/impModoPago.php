...
$aux = $opt; 
		...
		$tabla = $objModoPago->consultarModoPagoXidModoPago($aux);
		$objModoPago->cerrarConexion();
		if ($tabla > 0) {
			$etiquetas = array('id', 'cod', 'nom');
			$campos = array('idModoPago', 'codModoPago', 'nomModoPago');
