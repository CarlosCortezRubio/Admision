 ...
 *  
 * Imprimir de la Tabla UniEjecutora 
 * 
 * @author UNM 
 * @version V 0.1 
 * @date 28/07/2021
...
$aux = $opt; 
		...
		$tabla = $objUniEjecutora->consultarUniEjecutoraXidUniEjecutora($aux);
		$objUniEjecutora->cerrarConexion();
		if ($tabla > 0) {
			$etiquetas = array('id', 'cod', 'nom');
			$campos = array('idUniEjecutora', 'codUniEjecutora', 'nomUniEjecutora');
