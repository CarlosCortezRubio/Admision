...
/* FIN PAGINACION */ 
			$etiquetas = array('','Imp','Ver','Editar','Id','Nom','Desc','Grupo');
		if ($resultado!=null) {
			...
			$campos = array('obj_' . $chk, 'obj_' . $img3,'obj_' . $img, 'obj_' . $img1,'idEdoRegistro','nomEdoRegistro','descEdoRegistro','grupoEdoRegistro');
