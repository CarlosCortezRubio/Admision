 ...
 *  
 * Imprimir de la Tabla TipoPlanilla 
 * 
 * @author UNM 
 * @version V 0.1 
 * @date 28/07/2021
...
$aux = $opt; 
		...
		$tabla = $objTipoPlanilla->consultarTipoPlanillaXidTipoPlanilla($aux);
		$objTipoPlanilla->cerrarConexion();
		if ($tabla > 0) {
			$etiquetas = array('id', 'nom');
			$campos = array('idTipoPlanilla', 'nomTipoPlanilla');
