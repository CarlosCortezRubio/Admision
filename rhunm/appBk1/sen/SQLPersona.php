...
{ 
  ...
  const CONSULTAR_PERSONA_MULTI_X_ID="SELECT * FROM persona p INNER JOIN tipodoc td on p.idTipoDoc=td.idTipoDoc INNER JOIN via v ON p.idVia=v.idVia INNER JOIN zona z ON p.idZona=z.idZona INNER JOIN distrito d on p.idDistritoDir=d.idDistrito INNER JOIN distrito dis on p.idDistritoNac = dis.idDistrito INNER JOIN edocivil ec ON p.idEdoCivil=ec.idEdoCivil INNER JOIN genero ge ON p.idGenero=ge.idGenero INNER JOIN idioma id ON p.idIdioma =id.idIdioma  where p.idPersona=? ORDER BY p.idPersona";
  const CONSULTAR_PERSONA_MULTI="SELECT * FROM persona p INNER JOIN tipodoc td on p.idTipoDoc=td.idTipoDoc INNER JOIN via v ON p.idVia=v.idVia INNER JOIN zona z ON p.idZona=z.idZona INNER JOIN distrito d on p.idDistritoDir=d.idDistrito INNER JOIN distrito dis on p.idDistritoNac = dis.idDistrito INNER JOIN edocivil ec ON p.idEdoCivil=ec.idEdoCivil INNER JOIN genero ge ON p.idGenero=ge.idGenero INNER JOIN idioma id ON p.idIdioma =id.idIdioma ORDER BY p.idPersona";
  const CONSULTAR_PERSONA_DNI_MUTI="SELECT * FROM persona p INNER JOIN tipodoc td on p.idTipoDoc=td.idTipoDoc INNER JOIN via v ON p.idVia=v.idVia INNER JOIN zona z ON p.idZona=z.idZona INNER JOIN distrito d on p.idDistritoDir=d.idDistrito INNER JOIN distrito dis on p.idDistritoNac = dis.idDistrito INNER JOIN edocivil ec ON p.idEdoCivil=ec.idEdoCivil INNER JOIN genero ge ON p.idGenero=ge.idGenero INNER JOIN idioma id ON p.idIdioma =id.idIdioma where UPPER(p.dniPersona) LIKE UPPER(?) ORDER BY p.idPersona";
  const CONSULTAR_PERSONA_NOMBRE_MUTI="SELECT * FROM persona p INNER JOIN tipodoc td on p.idTipoDoc=td.idTipoDoc INNER JOIN via v ON p.idVia=v.idVia INNER JOIN zona z ON p.idZona=z.idZona INNER JOIN distrito d on p.idDistritoDir=d.idDistrito INNER JOIN distrito dis on p.idDistritoNac = dis.idDistrito INNER JOIN edocivil ec ON p.idEdoCivil=ec.idEdoCivil INNER JOIN genero ge ON p.idGenero=ge.idGenero INNER JOIN idioma id ON p.idIdioma =id.idIdioma where UPPER(p.nom1Persona) LIKE UPPER(?) OR UPPER(p.nom2Persona) LIKE UPPER(?) OR UPPER(p.ape1Persona) LIKE UPPER(?) or UPPER(p.ape2Persona) LIKE UPPER(?) ORDER  BY p.idPersona";
