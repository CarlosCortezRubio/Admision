...
class SQLUsuario 
{ 
  const AGREGAR_USUARIO = "INSERT INTO Usuario (idUsuario, idPersona, idRol, idEdoRegistro, cuentaUsuario, contrasenaUsuario, fecCreacion, pregSecreta, respPregSecreta) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?) ";

  const ACTUALIZAR_USUARIO = "UPDATE Usuario SET idUsuario = ?, idPersona = ?, idRol = ?, idEdoRegistro = ?, cuentaUsuario = ?, contrasenaUsuario = ?, fecCreacion = ?, pregSecreta = ?, respPregSecreta = ? WHERE idUsuario = ?";
