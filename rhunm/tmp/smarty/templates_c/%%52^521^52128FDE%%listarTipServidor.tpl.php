<?php /* Smarty version 2.6.30, created on 2022-01-10 21:35:13
         compiled from C:%5Claragon%5Cwww%5Crhunm/app/vista/TipServidor/listarTipServidor.tpl */ ?>
<!-- <script type='text/javascript' src='<?php echo $this->_tpl_vars['PATH_JS_XAJAX']; ?>
TipServidor.js'></script>-->
...
' readonly/>
		<input type='hidden' id='TipServidorid' name='TipServidorid' value='<?php echo $this->_tpl_vars['TipServidorid']; ?>
' readonly/>
