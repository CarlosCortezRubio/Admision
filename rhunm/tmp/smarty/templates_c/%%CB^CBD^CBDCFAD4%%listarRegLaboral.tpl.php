<?php /* Smarty version 2.6.30, created on 2021-11-01 19:25:13
         compiled from C:%5Claragon%5Cwww%5Crhunm/app/vista/RegLaboral/listarRegLaboral.tpl */ ?>
<!-- <script type='text/javascript' src='<?php echo $this->_tpl_vars['PATH_JS_XAJAX']; ?>
RegLaboral.js'></script>-->
...
' readonly/>
		<input type='hidden' id='RegLaboralid' name='RegLaboralid' value='<?php echo $this->_tpl_vars['RegLaboralid']; ?>
' readonly/>
