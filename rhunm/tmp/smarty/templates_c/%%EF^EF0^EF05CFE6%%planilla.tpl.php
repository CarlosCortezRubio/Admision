<?php /* Smarty version 2.6.30, created on 2021-12-16 18:43:11
         compiled from C:%5Claragon%5Cwww%5Crhunm/app/vista/planilla/planilla.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'C:\\laragon\\www\\rhunm/app/vista/planilla/planilla.tpl', 76, false),array('modifier', 'date_format', 'C:\\laragon\\www\\rhunm/app/vista/planilla/planilla.tpl', 200, false),)), $this); ?>
<?php echo '
			...
			<div class="form-group col-lg-12" style="position:fixed;z-index: 2000;top: 188px;left: 250px;">			
				<nav>
					<div class="nav nav-tabs" id="nav-tab" role="tablist">
						<a class="nav-item nav-link active" id="nav-secone-tab" data-toggle="tab" href="#home" role="tab" aria-controls="nav-home" aria-selected="true" onclick="totalizar();">DATOS PERSONALES/ADICIONALES</a>
						<a class="nav-item nav-link" id="nav-sectwo-tab" data-toggle="tab" href="#menu1" role="tab" aria-controls="nav-menu1" aria-selected="false" onclick="totalizar();">INGRESOS</a>
						<a class="nav-item nav-link" id="nav-secthree-tab" data-toggle="tab" href="#menu2" role="tab" aria-controls="nav-menu2" aria-selected="false" onclick="totalizar()";>DESCUENTOS</a>
						<a class="nav-item nav-link" id="nav-secfour-tab" data-toggle="tab" href="#menu3" role="tab" aria-controls="nav-menu3" aria-selected="false" onclick="totalizar();">TOTALES</a>
						<a class="nav-item nav-link" id="nav-secfive-tab" data-toggle="tab" href="#menu4" role="tab" aria-controls="nav-menu4" aria-selected="false" onclick="totalizar();">VARIACIONES</a>
					</div>
				</nav>
			</div>
		</div>
...
' maxlength='64' class='form-control input-sm' readonly />
								...
								<div class="form-group col-lg-2">
									...
									<div class=""> 
																				<input id='codModularPersona' name='codModularPersona' value='<?php echo $this->_tpl_vars['docPersona']; ?>
...
' maxlength='10' readonly>
						...
						<div class="tab-pane fade" id="menu4" role="tabpanel" aria-labelledby="menu4-tab">
							<div class="row">
								<div class="form-group col-lg-3">
									<input type="checkbox" id="Check1" onchange="activar('Check1','diaTrabajados')">
									<label class="control-label">Dias trabajados </label>
									<div class="">
										<div class="input-group input-group-sm">
										<input id='diaTrabajados' name='diaTrabajados' class='form-control input-sm' type='text' value='<?php echo $this->_tpl_vars['diaTrabajados']; ?>
' maxlength='10' disabled>
										</div>
									</div>
								</div>
								<div class="form-group col-lg-3">
									<input type="checkbox" id="Check2" onclick="activar('Check2','permisos')">
									<label class="control-label">Permisos </label>
									<div class="">
										<div class="input-group input-group-sm">
											<input id='permisos' name='permisos' class='form-control input-sm' type='text' value='<?php echo $this->_tpl_vars['permisos']; ?>
' maxlength='10' disabled>
										</div>
									</div>
								</div>
								<div class="form-group col-lg-3">
									<input type="checkbox" id="Check3" onclick="activar('Check3','huelgas')">
									<label class="control-label">Huelgas </label>
									<div class="">
										<div class="input-group input-group-sm">
								<input id='huelgas' name='huelgas' class='form-control input-sm' type='text' value='<?php echo $this->_tpl_vars['huelgas']; ?>
' maxlength='10' disabled>
								</div>
									</div>
								</div>
								<div class="form-group col-lg-3">
									<input type="checkbox" id="Check4" onclick="activar('Check4','inasistencias')">
									<label class="control-label">inasistencias </label>
									<div class="">
										<div class="input-group input-group-sm">
											<input id='inasistencias' name='inasistencias' class='form-control input-sm' type='text' value='<?php echo $this->_tpl_vars['inasistencias']; ?>
' maxlength='10' disabled>
										</div>
									</div>	
								</div>
								<div class="form-group col-lg-3">
									<input type="checkbox" id="Check5" onclick="activar('Check5','licencia')">
									<label class="control-label">Dias de licencia </label>
									<div class="">
										<div class="input-group input-group-sm">
											<input id='licencia' name='licencia' class='form-control input-sm' type='text' value='<?php echo $this->_tpl_vars['licencia']; ?>
' maxlength='10' disabled>
										</div>
									</div>	
								</div>
		
								<div id='fechLicencia' class="form-group col-lg-3" style="visibility:hidden">
							
									<label class="control-label">Fecha de inicio de licencia</label>
									<div class="">
										<div class="input-group input-group-sm">
											<input id='fechLic' name='fechLic' class='form-control input-sm' type='text' value='<?php echo $this->_tpl_vars['fechLic']; ?>
' maxlength='10' disabled>
										</div>
									</div>
							</div>
...
function totalizar(){
	...
	*/
	...
	R4 = parseFloat(noNulo(\'idConc_522\'));	
	 ...
	 dias = jQuery(\'#diaTrabajados\').val();
	 permisos = jQuery(\'#permisos\').val();
	 huelgas = jQuery(\'#huelgas\').val();
	 inasistencias = jQuery(\'#inasistencias\').val();
	 licencias = jQuery(\'#licencia\').val();
	
	//console.log(dias  +\'-\'+ permisos +\'-\'+ huelgas +\'-\'+ inasistencias +\'-\'+ licencias);
...
function activar(valor,valor2) {
	...
	if(document.getElementById(valor).checked){
		...
		if(valor == "Check5"){
			document.getElementById("fechLic").disabled= false;
			document.getElementById("fechLicencia").style.visibility = \'visible\';
		    //document.getElementById("fechLic").focus();
		}

		}else{
			document.getElementById(valor2).disabled= true;	
			document.getElementById("fechLicencia").style.visibility = \'hidden\';
