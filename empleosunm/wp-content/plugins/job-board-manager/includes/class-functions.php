...
class class_job_bm_functions{
	...
	public function job_type_list(){
		...
		$job_type_list = array(
		    'full-time'=>__('Tiempo completo', 'job-board-manager'),
            'freelance'=>__('Freelance', 'job-board-manager'),
            'internship'=>__('Internship', 'job-board-manager'),
            'part-time'=>__('Medio tiempo', 'job-board-manager'),
            'temporary'=>__('Temporal', 'job-board-manager')
        );
	...
	public function job_status_list(){
		...
		$job_status_list = array(
		    'open'=>__('Abierto', 'job-board-manager'),
            'closed'=>__('Cerrado', 'job-board-manager'),
            'filled'=>__('Filled', 'job-board-manager'),
            're-open'=>__('Re-Open', 'job-board-manager'),
            'expired'=>__('Expirado', 'job-board-manager')
        );
	...
	public function salary_type_list(){
		...
		$salary_type_list = array(
		    'negotiable'=>__('Negociable', 'job-board-manager'),  
            'fixed'=>__('Fijo', 'job-board-manager'),
            'min-max'=>__('Rango', 'job-board-manager')
        );
    ...
    public function salary_duration_list(){
        ...
        $salary_type_list = array(
            'hour'=>__('Por hora', 'job-board-manager'),
            'day'=>__('Por día', 'job-board-manager'),
            'week'=>__('Por semana', 'job-board-manager'),
            'month'=>__('Por mes', 'job-board-manager'),
            'year'=>__('Por año', 'job-board-manager'),
	...
	public function apply_method_list(){
		...
		$apply_method_list = array(
            ...
            'direct_email'=>sprintf(__('%s Por correo', 'job-board-manager'),'<i class="fas fa-envelope-open-text"></i>'),
            'external_website'=>sprintf(__('%s Sitio Web', 'job-board-manager'),'<i class="fas fa-external-link-alt"></i>'),
	...
	public function reports_tabs(){
		...
		$reports_tabs = array(
					'job'=>array(
								'title'=>__('Empleo', 'job-board-manager'),
