...
function job_bm_job_submit_form_title(){
    ...
    <div class="form-field-wrap is_required">
        <div class="field-title"><?php echo __('Título del empleo','job-board-manager'); ?></div>
        <div class="field-input">
            <input placeholder="" type="text" value="<?php echo esc_attr($post_title); ?>" name="post_title">
            <p class="field-details"><?php _e('Escriba el Título del empleo','job-board-manager');
            ?></p>
        </div>
    </div>
    <?php
...
function job_bm_job_submit_form_content(){
    ...
    ?>
    <div class="form-field-wrap is_required">
        <div class="field-title"><?php _e('Descripción del empleo','job-board-manager'); ?></div>
        <div class="field-input">
            <?php
            ob_start();
            ...
            <p class="field-details"><?php _e('Detalles del trabajo','job-board-manager'); ?></p>
...
function job_bm_job_submit_form_categories(){
    ...
    <div class="form-field-wrap">
        <div class="field-title"><?php _e('Categoría','job-board-manager'); ?></div>
        <div class="field-input">
            ...
            <p class="field-details"><?php _e('Seleccione la Categoría.','job-board-manager'); ?></p>
...
function job_bm_job_submit_form_job_info_title(){
    ...
    ?>
    <div class="form-field-wrap ">
        <div class="field-separator"><?php echo __('Información del empleo','job-board-manager'); ?></div>
    </div>
    <?php
}
...
function job_bm_job_submit_form_total_vacancies(){
    ...
    ?>
    <div class="form-field-wrap is_required">
        <div class="field-title"><?php _e('Puestos disponibles','job-board-manager'); ?></div>
        <div class="field-input">
            <input placeholder="3" type="text" value="<?php echo esc_attr($job_bm_total_vacancies); ?>" name="job_bm_total_vacancies">
            <p class="field-details"><?php _e('Número de puestos disponibles','job-board-manager');
                ?></p>
        </div>
    </div>
    <?php
...
function job_bm_job_submit_form_job_type(){
    ...
    ?>
    <div class="form-field-wrap">
        <div class="field-title"><?php _e('Tipo de empleo','job-board-manager'); ?></div>
        <div class="field-input">
            ...
            <p class="field-details"><?php _e('Seleccione un tipo de empleo.','job-board-manager'); ?></p>
...
function job_bm_job_submit_form_job_level(){
    ...
    ?>
    <div class="form-field-wrap">
        <div class="field-title"><?php _e('Nivel','job-board-manager'); ?></div>
        <div class="field-input">
            ...
            <p class="field-details"><?php _e('Seleccione el nivel.','job-board-manager'); ?></p>
...
function job_bm_job_submit_form_years_experience(){
    ...
    ?>
    <div class="form-field-wrap">
        <div class="field-title"><?php _e('Años de experiencia','job-board-manager'); ?></div>
        <div class="field-input">
            <input placeholder="5" type="text" value="<?php echo esc_attr($job_bm_years_experience); ?>" name="job_bm_years_experience">
            <p class="field-details"><?php _e('Años de experiencia.','job-board-manager');
                ?></p>
        </div>
    </div>
    <?php
...
function job_bm_job_submit_form_salary_type(){
    ...
    ?>
    <div class="form-field-wrap">
        <div class="field-title"><?php _e('Modalidad del salario','job-board-manager'); ?></div>
        <div class="field-input">
            ...
            <p class="field-details"><?php _e('Seleccione la modalidad del salario.','job-board-manager'); ?></p>
...
function job_bm_job_submit_form_salary_duration(){
    ...
    <div class="form-field-wrap salary_duration">
        <div class="field-title"><?php _e('Duración','job-board-manager'); ?></div>
        <div class="field-input">
            ...
            <p class="field-details"><?php _e('Seleccione la duración.','job-board-manager'); ?></p>
...
function job_bm_job_submit_form_contact_email(){
    ...
    ?>
    <div class="form-field-wrap is_required">
        <div class="field-title"><?php _e('Correo electrónico de contacto','job-board-manager'); ?></div>
        <div class="field-input">
            <input placeholder="contacto@unm.edu.pe" type="email" value="<?php echo esc_attr($job_bm_contact_email); ?>" name="job_bm_contact_email">
            <p class="field-details"><?php _e('Escriba el correo electrónico de contacto','job-board-manager');
                ?></p>
        </div>
    </div>
    ...
    if(!is_user_logged_in() && $job_bm_job_submit_create_account == 'yes'):
        ...
        <div class="form-field-wrap">
            ...
            <div class="field-input">
                ...
                <input style="display: <?php if($job_bm_create_account) echo 'block'; else echo 'none'; ?>" placeholder="usuario" type="text" value="<?php echo esc_attr($job_bm_username); ?>" name="job_bm_username">
...
function job_bm_job_submit_form_company_info(){
    ...
    ?>
    <div class="form-field-wrap ">
        <div class="field-separator"><?php echo __('Información de la compañia','job-board-manager'); ?></div>
    </div>
    <?php
}
...
function job_bm_job_submit_form_company_name(){
    ...
    ?>
    <div class="form-field-wrap is_required">
        <div class="field-title"><?php _e('Nombre de la compañia','job-board-manager'); ?></div>
        <div class="field-input">
            <input placeholder="" type="text" value="<?php echo esc_attr($job_bm_company_name); ?>" name="job_bm_company_name">
            <p class="field-details"><?php _e('Escriba el nombre de la compañia','job-board-manager');
                ?></p>
        </div>
    </div>
    <?php
...
function job_bm_job_submit_form_location(){
    ...
    ?>
    <div class="form-field-wrap is_required">
        <div class="field-title"><?php _e('Ubicación','job-board-manager'); ?></div>
        <div class="field-input">
            <input placeholder="Lima" type="text" value="<?php echo esc_attr($job_bm_location); ?>" name="job_bm_location">
            <p class="field-details"><?php _e('Escriba la ubicación de la compañia','job-board-manager');
                ?></p>
        </div>
    </div>
    <?php
...
function job_bm_job_submit_form_address(){
    ...
    ?>
    <div class="form-field-wrap is_required">
        <div class="field-title"><?php _e('Dirección','job-board-manager'); ?></div>
        <div class="field-input">
            <input placeholder="4549 Godfrey Road" type="text" value="<?php echo esc_attr($job_bm_address); ?>" name="job_bm_address">
            <p class="field-details"><?php _e('Escriba la dirección','job-board-manager');
                ?></p>
        </div>
    </div>
    <?php
...
function job_bm_job_submit_form_company_website(){
    ...
    ?>
    <div class="form-field-wrap">
        <div class="field-title"><?php _e('Sitio web','job-board-manager'); ?></div>
        <div class="field-input">
            <input placeholder="http://unm.edu.pe" type="text" value="<?php echo esc_url_raw($job_bm_company_website); ?>" name="job_bm_company_website">
            <p class="field-details"><?php _e('Escriba el sitio web','job-board-manager');
                ?></p>
        </div>
    </div>
    <?php
...
function job_bm_job_submit_form_job_link(){
    ...
    ?>
    <div class="form-field-wrap">
        <div class="field-title"><?php _e('Enlace del empleo','job-board-manager'); ?></div>
        <div class="field-input">
            <input placeholder="http://unm.edu.pe/detalles_trabajo" type="text" value="<?php echo esc_url_raw($job_bm_job_link); ?>" name="job_bm_job_link">
            <p class="field-details"><?php _e('Enlace del empleo','job-board-manager');
                ?></p>
        </div>
    </div>
    <?php
...
function job_bm_job_submit_form_company_logo(){
    ...
    <div class="form-field-wrap job-bm-media-upload">
        <div class="field-title"><?php _e('Logo','job-board-manager'); ?></div>
        <div class="field-input">
            ...
            if(is_user_logged_in()):
                ...
                <p class="field-details"><?php _e('Subir logo','job-board-manager'); ?></p>
                <?php
            else:
                ...
                <p class="field-details"><?php echo __('Puedes subir una imagen o utilizar el url del logo.','job-board-manager'); ?></p>
                <?php
...
function job_bm_job_submit_data($post_data){
    ...
    if(empty($post_data['post_title'])){
        ...
        $error->add( 'post_title', __( 'ERROR: Título del empleo está vacio.', 'job-board-manager' ) );
    }
    ...
    if(empty($post_data['job_bm_contact_email'])){
        $error->add( 'job_bm_contact_email', __( 'ERROR: Correo electrónico de contacto está vacío.', 'job-board-manager' ) );
    ...
    if(empty($post_data['job_bm_company_name'])){
        ...
        $error->add( 'job_bm_company_name', __( 'ERROR: Nombre de la compañia está vacío.', 'job-board-manager' ) );
    }
