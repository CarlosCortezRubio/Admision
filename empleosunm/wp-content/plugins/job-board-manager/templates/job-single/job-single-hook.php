...
if ( ! function_exists( 'job_bm_single_job_main_meta_start' ) ) {
    function job_bm_single_job_main_meta_start($job_id) {
        ...
        if($job_is_featured =='yes'):
            ob_start();
            ?>
            <span class=" meta-item featured"><i class="far fa-star"></i>  <?php echo __('Presentado','job-board-manager'); ?></span>
            <?php
        ...
        ob_start();
        ?>
        <span class="job-post-date meta-item"><i class="far fa-calendar-alt"></i> <?php echo sprintf(__('Publicado %s hace','job-board-manager'), human_time_diff( get_the_time( 'U' ), current_time( 'timestamp' ) ) )?></span>
        <?php
        ...
        if(!empty($job_categories)):
            ob_start();
            ?>
            <span class="job-category meta-item"><i class="fas fa-code-branch"></i> <?php echo sprintf(__('Publicado en %s','job-board-manager'), $job_categories )?></span>
            <?php
    ...
    function job_bm_single_job_main_company($job_id) {
        ...
        <div class="job-meta-company">
            ...
            if(!empty($job_company_name)):
                ?>
                <h3><?php echo __('Sobre la compañia','job-board-manager'); ?></h3>
            <?php endif; ?>
...
if ( ! function_exists( 'job_bm_single_job_main_job_info' ) ) {
    function job_bm_single_job_main_job_info($job_id) {
        ...
        if(!empty($job_status['status_name'])):
            ob_start();
            ?>
            <span class=" meta-item"><?php echo sprintf(__('%s Estado: %s','job-board-manager'),'<i class="fas fa-traffic-light"></i>', $job_status['status_name']); ?></span>
            <?php
        ...
        if($job_total_vacancies):
            ob_start();
            ?>
            <span class=" meta-item"><?php echo sprintf(__('%s N° de vacantes: %s','job-board-manager'),'<i class="fas fa-user-friends"></i>', $job_total_vacancies)?></span>
            <?php
        ...
        if(!empty($job_type['type'])):
            ob_start();
            ?>
                <span class=" meta-item"><?php echo sprintf(__('%s Tipo de empleo: %s','job-board-manager'),'<i class="fas fa-swatchbook"></i>', $job_type['type_name'])?></span>
            <?php
        ...
        if(!empty($job_level['level'])):
            ob_start();
            ?>
            <span class=" meta-item"><?php echo sprintf(__('%s Nivel: %s','job-board-manager'),'<i class="fas fa-users"></i>', $job_level['level_name'])?></span>
            <?php
        ...
        if($job_years_experience):
            ob_start();
            ?>
            <span class=" meta-item"><?php echo sprintf(__('%s Años de experiencia: %s', 'job-board-manager'),'<i class="fas fa-crosshairs"></i>', $job_years_experience)?></span>
            <?php
        ...
        if(!empty($job_salary_html)):
            ob_start();
                ?>
                <span class="meta-item"><?php echo sprintf(__('%s Salario: %s','job-board-manager'),'<i class="fas fa-pizza-slice"></i>', $job_salary_html); ?></span>
                <?php
        ...
        if(!empty($job_publish_date)):
            ob_start();
            ?>
            <span class="meta-item"><?php echo sprintf(__('%s Fecha de publicación: %s','job-board-manager'),'<i class="far fa-calendar-alt"></i>', $job_publish_date); ?></span>
            <?php
        ...
        if(!empty($job_expire_in)):
            ob_start();
            ?>
            <span class="meta-item"><?php echo sprintf(__('%s Finaliza en : %s','job-board-manager'),'<i class="far fa-calendar-check"></i>', $job_expire_in); ?></span>
            <?php
        ...
        <div class="job-meta-info">
            <h3><?php echo __('Información del empleo','job-board-manager'); ?></h3>
            <?php
...
if ( ! function_exists( 'job_bm_single_job_main_job_apply' ) ) {
    function job_bm_single_job_main_job_apply($job_id) {
        ...
        ?>
        <div class="job-apply">
            <h3><?php echo __('Aplicar al empleo','job-board-manager'); ?></h3>
