...
unset($_smarty_tpl_vars);
 ?>
		...
		<div id="barraMenuPrincipal" class='' style="background-color:#f8f9fa !important;height: 40px;">
			<?php if ($this->_tpl_vars['desactivar'] != true): ?>
<!--				<?php $_smarty_tpl_vars = $this->_tpl_vars;
...
unset($_smarty_tpl_vars);
 ?>-->
<!--				<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "../../../app/comun/menuusugeneral.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>-->
				<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "../../../app/comun/".($this->_tpl_vars['MENU_USU']).".tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
				<?php if ($this->_tpl_vars['actMenNom'] == true): ?>
					<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "../../../app/comun/menunomina.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
				<?php endif; ?>
<!--				 <div id="menu"><?php $_smarty_tpl_vars = $this->_tpl_vars;
