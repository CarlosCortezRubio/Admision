<?php /* Smarty version 2.6.30, created on 2021-06-07 16:07:57
         compiled from C:%5Cxampp%5Chtdocs%5Cdocentes/app/vista/PlanPens/PlanPens.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'C:\\xampp\\htdocs\\docentes/app/vista/PlanPens/PlanPens.tpl', 108, false),)), $this); ?>
<?php echo '
...
<!--  				<div class="form-group col-lg-12" style="position:fixed;background-color: azure;"> -->
 				<div class="form-group col-lg-12" style="position:fixed;z-index: 100000;top: 100px;">
					...
					<ul class="nav nav-tabs">
					  ...
					  <li class="nav-item">
					    <a class="nav-link" data-toggle="tab" href="#menu1">INGRESOS</a>
					  </li>
					  <li class="nav-item">
					    <a class="nav-link" data-toggle="tab" href="#menu2">DESCUENTOS</a>
					  </li>
					  <li class="nav-item">
					...
					<div class="tab-content">
					  	<div class="tab-pane container active row" id="home">
						  	<div class="row">
								...
								<div class="form-group col-lg-2">
									<label class="control-label">Mes [<?php echo $this->_tpl_vars['mes']; ?>
]</label>
									<div class="">
...
<script>
/*
TOTAL IMPONIBLE = sum(R4:BB4) + BF4 - AC4 - AF4 - R4 + BF4	
	AC4  = DS21 - 92 - PCM = ds21_92_pcmPlanPens
	AF4 = Igv = igvPlanPens
	R4 = AGUINALDO = aguinaldoPlanPens
	BF4 = ESCOLARIDAD = escolaridadPlanPens
	
TOTAL HABER =SUMA(R4:BB4)+[@ESCOLARIDAD]
	
	
TOTAL DESCUENTOS = SUMA(BC4+BD4+BE4)
BC4 = IPSS = ipssPlanPens
BD4 = CAFAE = cafaePlanPens
BE4 = PRDERRMA = prderrmaPlanPens

	BC4 = parseFloat(jQuery(\'#ipssPlanPens\').val();
	BD4 = parseFloat(jQuery(\'#cafaePlanPens\').val();
	BE4 = parseFloat(jQuery(\'$prderrmaPlanPens\').val();

TOTAL LIQUIDO = O4-P4
TOTAL HABER - TOTAL DESCUENTOS
...
function totalizar(){
	...
	totalImponible = sumIngreso + BF4 - AC4 - AF4 - R4 + BF4;
	totalHaber = sumIngreso + BF4;
	totalLiquido = totalHaber - sumDescuentos
	
		
	// Asignando resultados
	jQuery(\'#total_imponiblePlanPens\').val(totalImponible)
	jQuery(\'#total_haberPlanPens\').val(totalHaber);
	jQuery(\'#total_descuentosPlanPens\').val(sumDescuentos);
	jQuery(\'#total_liquidoPlanPens\').val(totalLiquido);
