					...
					<div class="tab-content">
					  	<div class="tab-pane container active row" id="home">
						  	<div class="row">
								...
								<div class="form-group col-lg-2">
									<label class="control-label">Mes [{$mes}]</label>
									<div class="">
					  ...
					  <div class="tab-pane container fade" id="menu2">
						  <div class="row">
							<div class="form-group col-lg-3">
								...
								<div class="">
									<input id='ipssPlanPens' name='ipssPlanPens' value='{$ipssPlanPens}' maxlength='64' class='form-control input-sm valDescuentos' />
								</div>
							</div>
							<div class="form-group col-lg-3">
							...
							<div class="form-group col-lg-3">
								...
								<div class="">
									<input id='escolaridadPlanPens' name='escolaridadPlanPens' value='{$escolaridadPlanPens}' maxlength='64' class='form-control input-sm valDescuentos' />
								</div>
							</div>
							<div class="form-group col-lg-3">
